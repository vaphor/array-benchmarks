...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_12_1_122_abs i2 acker1 i1 acker N i) (< i N)) (arrayassign_14_5_110_abs i2 acker1 i1 acker N i))))
...
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_14_5_110_abs i2 acker i vacker_0 N i) (arrayassign_14_5_110_abs i2 acker i1 vacker_0 N i)) (assign_15_5_119_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_0 N i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_19_1_204_abs i2 acker1 i1 acker N i) (< i N)) (arrayassign_21_5_192_abs i2 acker1 i1 acker N i))))
...
(assert (forall ( (i Int) (N Int) (acker1 Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= (- (- N i) 1) i2) (= vacker_0 vacker_1)) (arrayassign_21_5_192_abs (- (- N i) 1) vacker_0 i1 acker1 N i) (arrayassign_21_5_192_abs i2 vacker_0 i1 acker1 N i)) (assign_22_5_201_abs i2 vacker_0 i1 (ite (= i i1) vacker_0 acker1) N i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_26_1_290_abs i2 acker1 i1 acker N i) (< i N)) (assert_28_5_278_abs i2 acker1 i1 acker N i))))
