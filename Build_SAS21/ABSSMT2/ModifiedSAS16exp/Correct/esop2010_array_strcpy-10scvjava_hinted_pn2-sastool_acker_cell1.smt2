...
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_115_12_1_abs i2 acker1 i vacker_0 l i) (while_115_12_1_abs i2 acker1 i1 vacker_0 l i) (not (= 0 vacker_0))) (assert_89_13_12_abs i2 acker1 i1 vacker_0 l i))))
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_115_12_1_abs i2 acker1 i vacker_0 l i) (while_115_12_1_abs i2 acker1 i1 vacker_0 l i) (not (not (= 0 vacker_0)))) (assert_145_17_8_abs i2 acker1 i1 vacker_0 l i))))
;
