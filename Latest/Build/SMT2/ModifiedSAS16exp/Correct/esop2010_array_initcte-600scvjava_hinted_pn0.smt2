...
(declare-fun assert_21_12_161 ((Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_14_12_99 ((Array Int Int) Int Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_13_1_121 a  c  N  i ) (< i  N )) (assert_14_12_99 a  c  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (c Int) (a (Array Int Int)) ) ( => (assert_14_12_99 a  c  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (select a  k ) c )))))
(assert (forall ((i Int) (N Int) (c Int) (a (Array Int Int)) ) ( => (assert_14_12_99 a  c  N  i ) (arrayassign_15_5_109 a  c  N  i ))))
;
;(aassign) a[i] := c
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_20_1_187 a  c  N  i ) (< i  N )) (assert_21_12_161 a  c  N  i ))))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_20_1_187 a  c  N  i ) (not (< i  N ))) (end a  c  N  i ))))
;
;(assert)  (((0<=k)&&(k<N))=>(a[k]==c))
(assert (forall ((k Int) (i Int) (N Int) (c Int) (a (Array Int Int)) ) ( => (assert_21_12_161 a  c  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (select a  k ) c )))))
(assert (forall ((i Int) (N Int) (c Int) (a (Array Int Int)) ) ( => (assert_21_12_161 a  c  N  i ) (assert_22_5_175 a  c  N  i ))))
;
;(assert)  (a[i]==c)
