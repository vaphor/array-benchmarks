...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_119_11_6_abs i1 (select a i1) i1 (select a i1) v N i) (while_119_11_6_abs i1 (select a i1) i2 (select a i2) v N i) (while_119_11_6_abs i2 (select a i2) i1 (select a i1) v N i) (while_119_11_6_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assign_94_14_8_abs i2 (select a i2) i1 (select a i1) v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_194_20_6_abs i1 (select a i1) i1 (select a i1) v N i) (while_194_20_6_abs i1 (select a i1) i2 (select a i2) v N i) (while_194_20_6_abs i2 (select a i2) i1 (select a i1) v N i) (while_194_20_6_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (arrayassign_182_23_8_abs i2 (select a i2) i1 (select a i1) v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_269_28_6_abs i1 (select a i1) i1 (select a i1) v N i) (while_269_28_6_abs i1 (select a i1) i2 (select a i2) v N i) (while_269_28_6_abs i2 (select a i2) i1 (select a i1) v N i) (while_269_28_6_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_257_31_8_abs i2 (select a i2) i1 (select a i1) v N i))))
