...
(assert (forall ( (i Int) (k Int) (size Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_71_13_5_abs i2 acker i vacker_0 size k i) (arrayassign_71_13_5_abs i2 acker i1 vacker_1 size k i)) (assign_80_14_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_1 size k i))))
;
;(assign)  i := (i+1)
...
(assert (forall ( (i Int) (k Int) (size Int) (acker1 Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= (- (- size i) 1) i2) (= vacker_0 vacker_1)) (arrayassign_117_19_5_abs (- (- size i) 1) vacker_0 i1 acker1 size k i) (arrayassign_117_19_5_abs i2 vacker_1 i1 acker1 size k i)) (assign_126_20_5_abs i2 vacker_1 i1 (ite (= i i1) vacker_0 acker1) size k i))))
;
;(assign)  i := (i+1)
