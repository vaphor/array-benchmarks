...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_11_6_119_abs i1 acker v N i) (< i N)) (assign_14_8_94_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_20_6_194_abs i1 acker v N i) (< i N)) (arrayassign_23_8_182_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_28_6_269_abs i1 acker v N i) (< i N)) (assert_31_8_257_abs i1 acker v N i))))
