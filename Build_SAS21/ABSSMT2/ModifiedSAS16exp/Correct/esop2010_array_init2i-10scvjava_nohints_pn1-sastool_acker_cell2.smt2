...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_136_13_1_abs i1 vacker_0 i1 vacker_0 c N i) (while_136_13_1_abs i1 vacker_0 i2 vacker_0 c N i) (while_136_13_1_abs i2 vacker_0 i1 vacker_0 c N i) (while_136_13_1_abs i2 vacker_0 i2 vacker_0 c N i) (< i N)) (arrayassign_124_15_5_abs i2 vacker_0 i1 vacker_0 c N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_217_20_1_abs i1 vacker_0 i1 vacker_0 c N i) (while_217_20_1_abs i1 vacker_0 i2 vacker_0 c N i) (while_217_20_1_abs i2 vacker_0 i1 vacker_0 c N i) (while_217_20_1_abs i2 vacker_0 i2 vacker_0 c N i) (< i N)) (assert_205_22_5_abs i2 vacker_0 i1 vacker_0 c N i))))
