...
(declare-fun assert_23_12_166 (Int Int Int Int Int Int) Bool)
...
(declare-fun assert_16_12_96 (Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (and (while_15_1_122 a_copy_ind a_copy_val a_ind a_val N i) (< i N)) (assert_16_12_96 a_copy_ind a_copy_val a_ind a_val N i))))
...
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_a_copy Int)) (=> (and (assert_16_12_96 a_copy_ind a_copy_val a_ind a_val N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_16_12_96 k tmp_select_a_copy a_ind a_val N i)) (and (< a_copy_ind k) (assert_16_12_96 k tmp_select_a_copy a_ind a_val N i))) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_16_12_96 a_copy_ind a_copy_val k tmp_select_a N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_16_12_96 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_copy_ind k) (assert_16_12_96 k tmp_select_a_copy k tmp_select_a N i)))) (and (< a_ind k) (assert_16_12_96 a_copy_ind a_copy_val k tmp_select_a N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_16_12_96 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_copy_ind k) (assert_16_12_96 k tmp_select_a_copy k tmp_select_a N i)))))) (=> (and (<= 0 k) (< k i)) (= tmp_select_a_copy tmp_select_a)))))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (assert_16_12_96 a_copy_ind a_copy_val a_ind a_val N i) (arrayassign_17_5_110 a_copy_ind a_copy_val a_ind a_val N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (and (while_22_1_196 a_copy_ind a_copy_val a_ind a_val N i) (< i N)) (assert_23_12_166 a_copy_ind a_copy_val a_ind a_val N i))))
...
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_a_copy Int)) (=> (and (assert_23_12_166 a_copy_ind a_copy_val a_ind a_val N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_23_12_166 k tmp_select_a_copy a_ind a_val N i)) (and (< a_copy_ind k) (assert_23_12_166 k tmp_select_a_copy a_ind a_val N i))) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_23_12_166 a_copy_ind a_copy_val k tmp_select_a N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_23_12_166 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_copy_ind k) (assert_23_12_166 k tmp_select_a_copy k tmp_select_a N i)))) (and (< a_ind k) (assert_23_12_166 a_copy_ind a_copy_val k tmp_select_a N i) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_23_12_166 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_copy_ind k) (assert_23_12_166 k tmp_select_a_copy k tmp_select_a N i)))))) (=> (and (<= 0 k) (< k N)) (= tmp_select_a_copy tmp_select_a)))))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (assert_23_12_166 a_copy_ind a_copy_val a_ind a_val N i) (assert_24_5_184 a_copy_ind a_copy_val a_ind a_val N i))))
;
;(assert)  (a_copy[i]==a[i])
