...
(assert (forall ((elem Int) (pos Int) (N Int) (i Int) (vabs_0_f_f Int) (a_select Int)) (=> (and (while_17_1_145_abs0 vabs_0_f_f a_select elem pos N i) (< i N)) (if_19_5_134_abs0 vabs_0_f_f a_select elem pos N i))))
...
(assert (forall ((elem Int) (pos Int) (N Int) (i Int) (vabs_0_f_f Int) (a_select Int)) (=> (and (while_27_8_216_abs0 vabs_0_f_f a_select elem pos N i) (< i pos)) (assert_30_10_204_abs0 vabs_0_f_f a_select elem pos N i))))
