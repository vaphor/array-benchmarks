...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_12_1_125_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_13_12_99_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_13_12_99_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_13_12_99_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_14_5_113_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_19_1_202_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_20_12_172_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_20_12_172_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k N)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_20_12_172_abs i2 (select a_copy i2) i1 (select a i1) N i) (assert_21_5_190_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
;(assert)  (a[i]==a_copy[i])
