...
(declare-fun assert_30_8_240 (Int Int Int Int Int) Bool)
...
(declare-fun assert_22_8_165 (Int Int Int Int Int) Bool)
...
(declare-fun assert_13_8_82 (Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_11_6_119 a_ind a_val v N i) (< i N)) (assert_13_8_82 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_13_8_82 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_13_8_82 k tmp_select_a v N i)) (and (< a_ind k) (assert_13_8_82 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 0)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_13_8_82 a_ind a_val v N i) (assign_14_8_94 a_ind a_val v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_20_6_194 a_ind a_val v N i) (< i N)) (assert_22_8_165 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_22_8_165 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_22_8_165 k tmp_select_a v N i)) (and (< a_ind k) (assert_22_8_165 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_22_8_165 a_ind a_val v N i) (arrayassign_23_8_182 a_ind a_val v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_28_6_269 a_ind a_val v N i) (< i N)) (assert_30_8_240 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_30_8_240 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_30_8_240 k tmp_select_a v N i)) (and (< a_ind k) (assert_30_8_240 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k N)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_30_8_240 a_ind a_val v N i) (assert_31_8_257 a_ind a_val v N i))))
;
;(assert)  ((a[i]%2)==1)
