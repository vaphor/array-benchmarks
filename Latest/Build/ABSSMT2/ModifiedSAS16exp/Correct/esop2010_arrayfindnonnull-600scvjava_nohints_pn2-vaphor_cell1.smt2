...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (pos Int)) (=> (and (while_148_14_1 a_ind a_val pos N i) (< i N)) (if_137_16_5 a_ind a_val pos N i))))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (pos Int)) (=> (and (while_217_23_1 a_ind a_val pos N i) (< i pos)) (assert_205_26_10 a_ind a_val pos N i))))
