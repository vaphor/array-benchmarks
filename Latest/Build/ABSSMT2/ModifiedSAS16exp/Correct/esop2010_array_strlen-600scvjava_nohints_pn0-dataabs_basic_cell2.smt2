...
;
;(while)   while((i<l))
(assert (forall ( (source (Array Int Int)) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_19_1_169_abs i1 (select source i1) i1 (select source i1) l i) (while_19_1_169_abs i1 (select source i1) i2 (select source i2) l i) (while_19_1_169_abs i2 (select source i2) i1 (select source i1) l i) (while_19_1_169_abs i2 (select source i2) i2 (select source i2) l i) (< i l)) (assert_21_5_157_abs i2 (select source i2) i1 (select source i1) l i))))
