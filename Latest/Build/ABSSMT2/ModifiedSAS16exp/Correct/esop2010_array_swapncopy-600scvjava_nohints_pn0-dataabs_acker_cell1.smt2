...
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker2 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_15_5_105_abs i4 acker i3 acker1 i2 acker2 i vacker_0 N i) (arrayassign_15_5_105_abs i4 acker i3 acker1 i2 acker2 i1 vacker_1 N i)) (arrayassign_16_12_119_abs i4 acker i3 (ite (= i i3) vacker_0 acker1) i2 acker2 i1 vacker_1 N i))))
;
;(aassign) b_copy[i] := b[i]
(assert (forall ( (i Int) (N Int) (acker3 Int) (vacker_1 Int) (vacker_0 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i2) (= vacker_0 vacker_1)) (arrayassign_16_12_119_abs i4 acker i3 acker1 i vacker_0 i1 acker3 N i) (arrayassign_16_12_119_abs i4 acker i3 acker1 i2 vacker_1 i1 acker3 N i)) (assign_17_5_128_abs i4 (ite (= i i4) vacker_0 acker) i3 acker1 i2 vacker_1 i1 acker3 N i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<N))
(assert (forall ( (acker3 Int) (acker2 Int) (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (while_20_1_245_abs i4 acker3 i3 acker2 i2 acker1 i1 acker N i) (< i N)) (arrayassign_23_5_219_abs i4 acker3 i3 acker2 i2 acker1 i1 acker N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker3 Int) (acker2 Int) (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (while_29_8_367_abs i4 acker3 i3 acker2 i2 acker1 i1 acker N i) (< i N)) (assert_32_3_337_abs i4 acker3 i3 acker2 i2 acker1 i1 acker N i))))
