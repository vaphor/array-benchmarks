...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_119_11_6_abs i1 acker v N i) (< i N)) (assign_94_14_8_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_194_20_6_abs i1 acker v N i) (< i N)) (arrayassign_182_23_8_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_269_28_6_abs i1 acker v N i) (< i N)) (assert_257_31_8_abs i1 acker v N i))))
