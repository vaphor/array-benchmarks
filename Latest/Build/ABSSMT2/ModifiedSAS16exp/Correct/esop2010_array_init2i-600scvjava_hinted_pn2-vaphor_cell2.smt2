...
(declare-fun assert_185_21_12 (Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_108_14_12 (Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (while_136_13_1 a0_ind a0_val a1_ind a1_val c N i) (< i N)) (assert_108_14_12 a0_ind a0_val a1_ind a1_val c N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_108_14_12 a0_ind a0_val a1_ind a1_val c N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_108_14_12 k tmp_select_a a1_ind a1_val c N i) (< k a0_ind) (assert_108_14_12 k tmp_select_a a0_ind a0_val c N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_108_14_12 k tmp_select_a a1_ind a1_val c N i) (< a0_ind k) (assert_108_14_12 a0_ind a0_val k tmp_select_a c N i)) (and (< a1_ind k) (< a1_ind k) (assert_108_14_12 a1_ind a1_val k tmp_select_a c N i) (< a0_ind k) (assert_108_14_12 a0_ind a0_val k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k i)) (= tmp_select_a (+ (* 2 k) c))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (assert_108_14_12 a0_ind a0_val a1_ind a1_val c N i)) (arrayassign_124_15_5 a0_ind a0_val a1_ind a1_val c N i))))
;
;(aassign) a[i] := ((2*i)+c)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (while_217_20_1 a0_ind a0_val a1_ind a1_val c N i) (< i N)) (assert_185_21_12 a0_ind a0_val a1_ind a1_val c N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_185_21_12 a0_ind a0_val a1_ind a1_val c N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_185_21_12 k tmp_select_a a1_ind a1_val c N i) (< k a0_ind) (assert_185_21_12 k tmp_select_a a0_ind a0_val c N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_185_21_12 k tmp_select_a a1_ind a1_val c N i) (< a0_ind k) (assert_185_21_12 a0_ind a0_val k tmp_select_a c N i)) (and (< a1_ind k) (< a1_ind k) (assert_185_21_12 a1_ind a1_val k tmp_select_a c N i) (< a0_ind k) (assert_185_21_12 a0_ind a0_val k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k N)) (= tmp_select_a (+ (* 2 k) c))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (assert_185_21_12 a0_ind a0_val a1_ind a1_val c N i)) (assert_205_22_5 a0_ind a0_val a1_ind a1_val c N i))))
;
;(assert)  (a[i]==((2*i)+c))
