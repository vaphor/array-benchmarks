...
(declare-fun assert_20_12_142 (Int Int Int Int) Bool)
...
(declare-fun assert_14_12_83 (Int Int Int Int) Bool)
...
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (while_13_1_95 source_ind source_val l i) (not (= tmp_select_source 0)) (or (and (= source_ind i) (= tmp_select_source source_val)) (and (< i source_ind) (while_13_1_95 i tmp_select_source l i)) (and (< source_ind i) (while_13_1_95 i tmp_select_source l i)))) (assert_14_12_83 source_ind source_val l i))))
...
(assert (forall ((i Int) (k Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (assert_14_12_83 source_ind source_val l i) (or (and (= source_ind k) (= tmp_select_source source_val)) (and (< k source_ind) (assert_14_12_83 k tmp_select_source l i)) (and (< source_ind k) (assert_14_12_83 k tmp_select_source l i)))) (=> (and (<= 0 k) (< k i)) (not (= tmp_select_source 0))))))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assert_14_12_83 source_ind source_val l i) (assign_15_5_92 source_ind source_val l i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<l))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (and (while_19_1_169 source_ind source_val l i) (< i l)) (assert_20_12_142 source_ind source_val l i))))
...
(assert (forall ((i Int) (k Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (assert_20_12_142 source_ind source_val l i) (or (and (= source_ind k) (= tmp_select_source source_val)) (and (< k source_ind) (assert_20_12_142 k tmp_select_source l i)) (and (< source_ind k) (assert_20_12_142 k tmp_select_source l i)))) (=> (and (<= 0 k) (< k l)) (not (= tmp_select_source 0))))))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assert_20_12_142 source_ind source_val l i) (assert_21_5_157 source_ind source_val l i))))
;
;(assert)  (!(source[i]==0))
