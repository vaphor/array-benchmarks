...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) ) ( => ( and (while_17_1_145 a  elem  pos  N  i ) (< i  N )) (if_19_5_134 a  elem  pos  N  i ))))
...
;
;(while)   while((i<pos))
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) ) ( => ( and (while_27_8_216 a  elem  pos  N  i ) (< i  pos )) (assert_30_10_204 a  elem  pos  N  i ))))
