...
(declare-rel assert_166_23_12_abs (Int Int Int Int Int Int))
...
(declare-rel assert_96_16_12_abs (Int Int Int Int Int Int))
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_122_15_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_96_16_12_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_96_16_12_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_96_16_12_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_110_17_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_196_22_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_166_23_12_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_166_23_12_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k N)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_166_23_12_abs i2 (select a_copy i2) i1 (select a i1) N i) (assert_184_24_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
;(assert)  (a_copy[i]==a[i])
