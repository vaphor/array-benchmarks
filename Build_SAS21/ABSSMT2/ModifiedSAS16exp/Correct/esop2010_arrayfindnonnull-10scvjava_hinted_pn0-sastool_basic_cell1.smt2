...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_14_1_148_abs i1 (select a i1) pos N i) (< i N)) (assert_15_13_105_abs i1 (select a i1) pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (a (Array Int Int))) (=> (and (assert_15_13_105_abs k (select a k) pos N i) (>= k 0) (< k i)) (= 0 (select a k)))))
(assert (forall ( (i Int) (N Int) (pos Int) (a (Array Int Int)) (i1 Int)) (=> (assert_15_13_105_abs i1 (select a i1) pos N i) (if_16_5_137_abs i1 (select a i1) pos N i))))
;
;(if)      if((!(a[i]==0)))
...
;
;(while)   while((i<pos))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_23_1_217_abs i1 (select a i1) pos N i) (< i pos)) (assert_25_10_191_abs i1 (select a i1) pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (a (Array Int Int))) (=> (and (assert_25_10_191_abs k (select a k) pos N i) (>= k 0) (< k pos)) (= 0 (select a k)))))
(assert (forall ( (i Int) (N Int) (pos Int) (a (Array Int Int)) (i1 Int)) (=> (assert_25_10_191_abs i1 (select a i1) pos N i) (assert_26_10_205_abs i1 (select a i1) pos N i))))
;
;(assert)  (a[i]==0)
