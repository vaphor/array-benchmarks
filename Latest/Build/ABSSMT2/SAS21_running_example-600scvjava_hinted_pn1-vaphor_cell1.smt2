...
(declare-fun assert_240_30_8 (Int Int Int Int Int) Bool)
...
(declare-fun assert_165_22_8 (Int Int Int Int Int) Bool)
...
(declare-fun assert_82_13_8 (Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_119_11_6 a_ind a_val v N i) (< i N)) (assert_82_13_8 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_82_13_8 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_82_13_8 k tmp_select_a v N i)) (and (< a_ind k) (assert_82_13_8 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 0)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_82_13_8 a_ind a_val v N i) (assign_94_14_8 a_ind a_val v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_194_20_6 a_ind a_val v N i) (< i N)) (assert_165_22_8 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_165_22_8 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_165_22_8 k tmp_select_a v N i)) (and (< a_ind k) (assert_165_22_8 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_165_22_8 a_ind a_val v N i) (arrayassign_182_23_8 a_ind a_val v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (and (while_269_28_6 a_ind a_val v N i) (< i N)) (assert_240_30_8 a_ind a_val v N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (assert_240_30_8 a_ind a_val v N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_240_30_8 k tmp_select_a v N i)) (and (< a_ind k) (assert_240_30_8 k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k N)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (v Int)) (=> (assert_240_30_8 a_ind a_val v N i) (assert_257_31_8 a_ind a_val v N i))))
;
;(assert)  ((a[i]%2)==1)
