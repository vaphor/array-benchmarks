...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (pos Int) (N Int) (i Int) ) ( => ( and (while_14_1_148 a  pos  N  i ) (< i  N )) (if_16_5_137 a  pos  N  i ))))
...
;
;(while)   while((i<pos))
(assert (forall ((a (Array Int Int)) (pos Int) (N Int) (i Int) ) ( => ( and (while_23_1_217 a  pos  N  i ) (< i  pos )) (assert_26_10_205 a  pos  N  i ))))
