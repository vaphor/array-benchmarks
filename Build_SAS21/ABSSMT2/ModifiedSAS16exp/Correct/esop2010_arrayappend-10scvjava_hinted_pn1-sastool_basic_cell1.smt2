...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_161_16_1_abs i2 (select b i2) i1 (select a i1) Nb Na i) (< i (+ Na Nb))) (assert_132_17_12_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_161_16_1_abs i2 (select b i2) i1 (select a i1) Nb Na i) (not (< i (+ Na Nb)))) (assert_200_21_8_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
;
;(assert)  (((Na<=k)&&(k<i))=>(a[k]==b[(k-Na)]))
(assert (forall ( (k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int))) (=> (and (assert_132_17_12_abs (- k Na) (select b (- k Na)) k (select a k) Nb Na i) (<= Na k) (< k i)) (= (select a k) (select b (- k Na))))))
(assert (forall ( (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_132_17_12_abs i2 (select b i2) i1 (select a i1) Nb Na i) (arrayassign_149_18_5_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
;
;(aassign) a[i] := b[(i-Na)]
...
(assert (forall ( (k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int))) (=> (and (assert_200_21_8_abs (- k Na) (select b (- k Na)) k (select a k) Nb Na i) (<= Na k) (< k (+ Na Nb))) (= (select a k) (select b (- k Na))))))
(assert (forall ( (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_200_21_8_abs i2 (select b i2) i1 (select a i1) Nb Na i) (assign_206_23_8_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
;
;(assign)  i := Na
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_289_24_1_abs i2 (select b i2) i1 (select a i1) Nb Na i) (< i (+ Na Nb))) (assert_256_25_11_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
...
;
;(assert)  (((Na<=k)&&(k<(Na+Nb)))=>(a[k]==b[(k-Na)]))
(assert (forall ( (k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int))) (=> (and (assert_256_25_11_abs (- k Na) (select b (- k Na)) k (select a k) Nb Na i) (<= Na k) (< k (+ Na Nb))) (= (select a k) (select b (- k Na))))))
(assert (forall ( (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_256_25_11_abs i2 (select b i2) i1 (select a i1) Nb Na i) (assert_277_26_11_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
;
;(assert)  (a[i]==b[(i-Na)])
