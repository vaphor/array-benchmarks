...
(declare-fun assert_31_10_319 ((Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
(declare-fun assert_30_10_289 ((Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
...
(declare-fun assert_22_12_205 ((Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
(declare-fun assert_21_12_175 ((Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((b_copy (Array Int Int)) (a_copy (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_20_1_245 b_copy  a_copy  b  a  N  i ) (< i  N )) (assert_21_12_175 b_copy  a_copy  b  a  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_21_12_175 b_copy  a_copy  b  a  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (select a_copy  k ) (select b  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_21_12_175 b_copy  a_copy  b  a  N  i ) (assert_22_12_205 b_copy  a_copy  b  a  N  i ))))
;
;(assert)  (((0<=k)&&(k<i))=>(b_copy[k]==a[k]))
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_22_12_205 b_copy  a_copy  b  a  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (select b_copy  k ) (select a  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_22_12_205 b_copy  a_copy  b  a  N  i ) (arrayassign_23_5_219 b_copy  a_copy  b  a  N  i ))))
;
...
;
;(while)   while((i<N))
(assert (forall ((b_copy (Array Int Int)) (a_copy (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_29_8_367 b_copy  a_copy  b  a  N  i ) (< i  N )) (assert_30_10_289 b_copy  a_copy  b  a  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_30_10_289 b_copy  a_copy  b  a  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (select a_copy  k ) (select b  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_30_10_289 b_copy  a_copy  b  a  N  i ) (assert_31_10_319 b_copy  a_copy  b  a  N  i ))))
;
;(assert)  (((0<=k)&&(k<N))=>(b_copy[k]==a[k]))
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_31_10_319 b_copy  a_copy  b  a  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (select b_copy  k ) (select a  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) ) ( => (assert_31_10_319 b_copy  a_copy  b  a  N  i ) (assert_32_3_337 b_copy  a_copy  b  a  N  i ))))
;
;(assert)  (a[i]==b_copy[i])
