...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_16_1_161_abs i2 (select b i2) i1 (select a i1) Nb Na i) (< i (+ Na Nb))) (arrayassign_18_5_149_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_16_1_161_abs i2 (select b i2) i1 (select a i1) Nb Na i) (not (< i (+ Na Nb)))) (assign_23_8_206_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
;
;(aassign) a[i] := b[(i-Na)]
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_24_1_289_abs i2 (select b i2) i1 (select a i1) Nb Na i) (< i (+ Na Nb))) (assert_26_11_277_abs i2 (select b i2) i1 (select a i1) Nb Na i))))
