...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_11_6_119_abs i1 (select a i1) i1 (select a i1) v N i) (while_11_6_119_abs i1 (select a i1) i2 (select a i2) v N i) (while_11_6_119_abs i2 (select a i2) i1 (select a i1) v N i) (while_11_6_119_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_13_8_82_abs i2 (select a i2) i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_13_8_82_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k i)) (= 0 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_13_8_82_abs i1 (select a i1) i1 (select a i1) v N i) (assert_13_8_82_abs i1 (select a i1) i2 (select a i2) v N i) (assert_13_8_82_abs i2 (select a i2) i1 (select a i1) v N i) (assert_13_8_82_abs i2 (select a i2) i2 (select a i2) v N i)) (assign_14_8_94_abs i2 (select a i2) i1 (select a i1) v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_20_6_194_abs i1 (select a i1) i1 (select a i1) v N i) (while_20_6_194_abs i1 (select a i1) i2 (select a i2) v N i) (while_20_6_194_abs i2 (select a i2) i1 (select a i1) v N i) (while_20_6_194_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_22_8_165_abs i2 (select a i2) i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_22_8_165_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k i)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_22_8_165_abs i1 (select a i1) i1 (select a i1) v N i) (assert_22_8_165_abs i1 (select a i1) i2 (select a i2) v N i) (assert_22_8_165_abs i2 (select a i2) i1 (select a i1) v N i) (assert_22_8_165_abs i2 (select a i2) i2 (select a i2) v N i)) (arrayassign_23_8_182_abs i2 (select a i2) i1 (select a i1) v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_28_6_269_abs i1 (select a i1) i1 (select a i1) v N i) (while_28_6_269_abs i1 (select a i1) i2 (select a i2) v N i) (while_28_6_269_abs i2 (select a i2) i1 (select a i1) v N i) (while_28_6_269_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_30_8_240_abs i2 (select a i2) i1 (select a i1) v N i))))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_28_6_269_abs i1 (select a i1) i1 (select a i1) v N i) (while_28_6_269_abs i1 (select a i1) i2 (select a i2) v N i) (while_28_6_269_abs i2 (select a i2) i1 (select a i1) v N i) (while_28_6_269_abs i2 (select a i2) i2 (select a i2) v N i) (not (< i N))) (end_abs i2 (select a i2) i1 (select a i1) v N i))))
;
;(assert)  (((0<=k)&&(k<N))=>((a[k]%2)==1))
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_30_8_240_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k N)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_30_8_240_abs i1 (select a i1) i1 (select a i1) v N i) (assert_30_8_240_abs i1 (select a i1) i2 (select a i2) v N i) (assert_30_8_240_abs i2 (select a i2) i1 (select a i1) v N i) (assert_30_8_240_abs i2 (select a i2) i2 (select a i2) v N i)) (assert_31_8_257_abs i2 (select a i2) i1 (select a i1) v N i))))
;
;(assert)  ((a[i]%2)==1)
