...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_121_13_1 a  c  N  i ) (< i  N )) (arrayassign_109_15_5 a  c  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_187_20_1 a  c  N  i ) (< i  N )) (assert_175_22_5 a  c  N  i ))))
