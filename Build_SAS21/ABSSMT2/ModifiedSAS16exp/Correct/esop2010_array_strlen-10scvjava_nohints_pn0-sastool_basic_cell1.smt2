...
(assert (forall ( (source (Array Int Int)) (l Int) (i Int) (i1 Int)) (=> (and (while_13_1_95_abs i (select source i) l i) (while_13_1_95_abs i1 (select source i1) l i) (not (= 0 (select source i)))) (assign_15_5_92_abs i1 (select source i1) l i))))
...
;
;(while)   while((i<l))
(assert (forall ( (source (Array Int Int)) (l Int) (i Int) (i1 Int)) (=> (and (while_19_1_169_abs i1 (select source i1) l i) (< i l)) (assert_21_5_157_abs i1 (select source i1) l i))))
