...
(declare-fun assert_189_29_10 (Int Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_103_18_12 (Int Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_145_17_1 a0_ind a0_val a1_ind a1_val elem pos N i) (< i N)) (assert_103_18_12 a0_ind a0_val a1_ind a1_val elem pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_103_18_12 a0_ind a0_val a1_ind a1_val elem pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_103_18_12 k tmp_select_a a1_ind a1_val elem pos N i) (< k a0_ind) (assert_103_18_12 k tmp_select_a a0_ind a0_val elem pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_103_18_12 k tmp_select_a a1_ind a1_val elem pos N i) (< a0_ind k) (assert_103_18_12 a0_ind a0_val k tmp_select_a elem pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_103_18_12 a1_ind a1_val k tmp_select_a elem pos N i) (< a0_ind k) (assert_103_18_12 a0_ind a0_val k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k i)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_103_18_12 a0_ind a0_val a1_ind a1_val elem pos N i)) (if_134_19_5 a0_ind a0_val a1_ind a1_val elem pos N i))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_216_27_8 a0_ind a0_val a1_ind a1_val elem pos N i) (< i pos)) (assert_189_29_10 a0_ind a0_val a1_ind a1_val elem pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_189_29_10 a0_ind a0_val a1_ind a1_val elem pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_189_29_10 k tmp_select_a a1_ind a1_val elem pos N i) (< k a0_ind) (assert_189_29_10 k tmp_select_a a0_ind a0_val elem pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_189_29_10 k tmp_select_a a1_ind a1_val elem pos N i) (< a0_ind k) (assert_189_29_10 a0_ind a0_val k tmp_select_a elem pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_189_29_10 a1_ind a1_val k tmp_select_a elem pos N i) (< a0_ind k) (assert_189_29_10 a0_ind a0_val k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k pos)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_189_29_10 a0_ind a0_val a1_ind a1_val elem pos N i)) (assert_204_30_10 a0_ind a0_val a1_ind a1_val elem pos N i))))
;
;(assert)  (!(a[i]==elem))
