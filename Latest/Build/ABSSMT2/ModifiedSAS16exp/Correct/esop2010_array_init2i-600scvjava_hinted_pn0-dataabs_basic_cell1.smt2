...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int)) (=> (and (while_13_1_136_abs i1 (select a i1) c N i) (< i N)) (assert_14_12_108_abs i1 (select a i1) c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_14_12_108_abs k (select a k) c N i) (<= 0 k) (< k i)) (= (+ (* 2 k) c) (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int)) (=> (assert_14_12_108_abs i1 (select a i1) c N i) (arrayassign_15_5_124_abs i1 (select a i1) c N i))))
;
;(aassign) a[i] := ((2*i)+c)
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int)) (=> (and (while_20_1_217_abs i1 (select a i1) c N i) (< i N)) (assert_21_12_185_abs i1 (select a i1) c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_21_12_185_abs k (select a k) c N i) (<= 0 k) (< k N)) (= (+ (* 2 k) c) (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int)) (=> (assert_21_12_185_abs i1 (select a i1) c N i) (assert_22_5_205_abs i1 (select a i1) c N i))))
;
;(assert)  (a[i]==((2*i)+c))
