...
(declare-fun assert_161_21_12 (Int Int Int Int Int) Bool)
...
(declare-fun assert_99_14_12 (Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_121_13_1 a_ind a_val c N i) (< i N)) (assert_99_14_12 a_ind a_val c N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (assert_99_14_12 a_ind a_val c N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_99_14_12 k tmp_select_a c N i)) (and (< a_ind k) (assert_99_14_12 k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k i)) (= tmp_select_a c)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (assert_99_14_12 a_ind a_val c N i) (arrayassign_109_15_5 a_ind a_val c N i))))
;
;(aassign) a[i] := c
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_187_20_1 a_ind a_val c N i) (< i N)) (assert_161_21_12 a_ind a_val c N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (assert_161_21_12 a_ind a_val c N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_161_21_12 k tmp_select_a c N i)) (and (< a_ind k) (assert_161_21_12 k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k N)) (= tmp_select_a c)))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (assert_161_21_12 a_ind a_val c N i) (assert_175_22_5 a_ind a_val c N i))))
;
;(assert)  (a[i]==c)
