...
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_110_14_5_abs i2 acker i vacker_0 N i) (arrayassign_110_14_5_abs i2 acker i1 vacker_1 N i)) (assign_119_15_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_1 N i))))
;
;(assign)  i := (i+1)
...
(assert (forall ( (i Int) (N Int) (acker1 Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= (- (- N i) 1) i2) (= vacker_0 vacker_1)) (arrayassign_192_21_5_abs (- (- N i) 1) vacker_0 i1 acker1 N i) (arrayassign_192_21_5_abs i2 vacker_1 i1 acker1 N i)) (assign_201_22_5_abs i2 vacker_1 i1 (ite (= i i1) vacker_0 acker1) N i))))
;
;(assign)  i := (i+1)
