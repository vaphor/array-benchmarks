...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_13_1_136 a  c  N  i ) (< i  N )) (arrayassign_15_5_124 a  c  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_20_1_217 a  c  N  i ) (< i  N )) (assert_22_5_205 a  c  N  i ))))
