...
;
;(while)   while((i<l))
(assert (forall ((i Int) (l Int) (source0_ind Int) (source0_val Int) (source1_ind Int) (source1_val Int)) (=> (and (< source0_ind source1_ind) (while_169_19_1 source0_ind source0_val source1_ind source1_val l i) (< i l)) (assert_157_21_5 source0_ind source0_val source1_ind source1_val l i))))
