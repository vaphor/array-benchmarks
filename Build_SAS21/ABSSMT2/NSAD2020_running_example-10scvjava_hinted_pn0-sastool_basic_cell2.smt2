...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_12_6_119_abs i1 (select a i1) i1 (select a i1) v N i) (while_12_6_119_abs i1 (select a i1) i2 (select a i2) v N i) (while_12_6_119_abs i2 (select a i2) i1 (select a i1) v N i) (while_12_6_119_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_14_8_82_abs i2 (select a i2) i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_14_8_82_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k i)) (= 0 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_14_8_82_abs i1 (select a i1) i1 (select a i1) v N i) (assert_14_8_82_abs i1 (select a i1) i2 (select a i2) v N i) (assert_14_8_82_abs i2 (select a i2) i1 (select a i1) v N i) (assert_14_8_82_abs i2 (select a i2) i2 (select a i2) v N i)) (assign_15_8_94_abs i2 (select a i2) i1 (select a i1) v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_22_6_194_abs i1 (select a i1) i1 (select a i1) v N i) (while_22_6_194_abs i1 (select a i1) i2 (select a i2) v N i) (while_22_6_194_abs i2 (select a i2) i1 (select a i1) v N i) (while_22_6_194_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_24_8_165_abs i2 (select a i2) i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_24_8_165_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k i)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_24_8_165_abs i1 (select a i1) i1 (select a i1) v N i) (assert_24_8_165_abs i1 (select a i1) i2 (select a i2) v N i) (assert_24_8_165_abs i2 (select a i2) i1 (select a i1) v N i) (assert_24_8_165_abs i2 (select a i2) i2 (select a i2) v N i)) (arrayassign_25_8_182_abs i2 (select a i2) i1 (select a i1) v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_31_6_269_abs i1 (select a i1) i1 (select a i1) v N i) (while_31_6_269_abs i1 (select a i1) i2 (select a i2) v N i) (while_31_6_269_abs i2 (select a i2) i1 (select a i1) v N i) (while_31_6_269_abs i2 (select a i2) i2 (select a i2) v N i) (< i N)) (assert_33_8_240_abs i2 (select a i2) i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_33_8_240_abs k (select a k) k (select a k) v N i) (<= 0 k) (< k N)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_33_8_240_abs i1 (select a i1) i1 (select a i1) v N i) (assert_33_8_240_abs i1 (select a i1) i2 (select a i2) v N i) (assert_33_8_240_abs i2 (select a i2) i1 (select a i1) v N i) (assert_33_8_240_abs i2 (select a i2) i2 (select a i2) v N i)) (assert_34_8_257_abs i2 (select a i2) i1 (select a i1) v N i))))
;
;(assert)  ((a[i]%2)==1)
