...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_122_15_1_abs i2 acker1 i1 acker N i) (< i N)) (assert_96_16_12_abs i2 acker1 i1 acker N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (acker1 Int) (acker Int)) (=> (and (assert_96_16_12_abs k acker k acker1 N i) (<= 0 k) (< k i)) (= acker acker1))))
(assert (forall ( (i Int) (N Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int)) (=> (assert_96_16_12_abs i2 acker i1 acker1 N i) (arrayassign_110_17_5_abs i2 acker i1 acker1 N i))))
;
;(aassign) a_copy[i] := a[i]
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_110_17_5_abs i2 acker i vacker_0 N i) (arrayassign_110_17_5_abs i2 acker i1 vacker_0 N i)) (assign_119_18_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_0 N i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_196_22_1_abs i2 acker1 i1 acker N i) (< i N)) (assert_166_23_12_abs i2 acker1 i1 acker N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (acker1 Int) (acker Int)) (=> (and (assert_166_23_12_abs k acker k acker1 N i) (<= 0 k) (< k N)) (= acker acker1))))
(assert (forall ( (i Int) (N Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int)) (=> (assert_166_23_12_abs i2 acker i1 acker1 N i) (assert_184_24_5_abs i2 acker i1 acker1 N i))))
;
;(assert)  (a_copy[i]==a[i])
