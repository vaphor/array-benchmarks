...
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_12_1_115_abs i2 acker1 i vacker_0 l i) (while_12_1_115_abs i2 acker1 i1 vacker_1 l i) (not (= 0 vacker_0))) (arrayassign_14_5_103_abs i2 acker1 i1 vacker_1 l i))))
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_12_1_115_abs i2 acker1 i vacker_0 l i) (while_12_1_115_abs i2 acker1 i1 vacker_1 l i) (not (not (= 0 vacker_0)))) (assign_18_1_151_abs i2 acker1 i1 vacker_1 l i))))
;
