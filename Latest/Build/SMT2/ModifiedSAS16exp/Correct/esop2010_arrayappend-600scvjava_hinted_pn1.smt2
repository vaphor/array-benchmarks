...
(declare-fun assert_256_25_11 ((Array Int Int) (Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_200_21_8 ((Array Int Int) (Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_132_17_12 ((Array Int Int) (Array Int Int) Int Int Int ) Bool)
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_161_16_1 b  a  Nb  Na  i ) (< i  (+ Na  Nb ))) (assert_132_17_12 b  a  Nb  Na  i ))))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_161_16_1 b  a  Nb  Na  i ) (not (< i  (+ Na  Nb )))) (assert_200_21_8 b  a  Nb  Na  i ))))
;
;(assert)  (((Na<=k)&&(k<i))=>(a[k]==b[(k-Na)]))
(assert (forall ((k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_132_17_12 b  a  Nb  Na  i ) (=> (and (<= Na  k ) (< k  i )) (= (select a  k ) (select b  (- k  Na )))))))
(assert (forall ((i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_132_17_12 b  a  Nb  Na  i ) (arrayassign_149_18_5 b  a  Nb  Na  i ))))
;
;(aassign) a[i] := b[(i-Na)]
...
(assert (forall ((k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_200_21_8 b  a  Nb  Na  i ) (=> (and (<= Na  k ) (< k  (+ Na  Nb ))) (= (select a  k ) (select b  (- k  Na )))))))
(assert (forall ((i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_200_21_8 b  a  Nb  Na  i ) (assign_206_23_8 b  a  Nb  Na  i ))))
;
;(assign)  i := Na
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_289_24_1 b  a  Nb  Na  i ) (< i  (+ Na  Nb ))) (assert_256_25_11 b  a  Nb  Na  i ))))
...
;
;(assert)  (((Na<=k)&&(k<(Na+Nb)))=>(a[k]==b[(k-Na)]))
(assert (forall ((k Int) (i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_256_25_11 b  a  Nb  Na  i ) (=> (and (<= Na  k ) (< k  (+ Na  Nb ))) (= (select a  k ) (select b  (- k  Na )))))))
(assert (forall ((i Int) (Na Int) (Nb Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_256_25_11 b  a  Nb  Na  i ) (assert_277_26_11 b  a  Nb  Na  i ))))
;
;(assert)  (a[i]==b[(i-Na)])
