...
(declare-fun assert_20_12_142 ((Array Int Int) Int Int ) Bool)
...
(declare-fun assert_14_12_83 ((Array Int Int) Int Int ) Bool)
...
(assert (forall ((source (Array Int Int)) (l Int) (i Int) ) ( => ( and (while_13_1_95 source  l  i ) (not (= (select source  i ) 0))) (assert_14_12_83 source  l  i ))))
...
(assert (forall ((k Int) (i Int) (l Int) (source (Array Int Int)) ) ( => (assert_14_12_83 source  l  i ) (=> (and (<= 0 k ) (< k  i )) (not (= (select source  k ) 0))))))
(assert (forall ((i Int) (l Int) (source (Array Int Int)) ) ( => (assert_14_12_83 source  l  i ) (assign_15_5_92 source  l  i ))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<l))
(assert (forall ((source (Array Int Int)) (l Int) (i Int) ) ( => ( and (while_19_1_169 source  l  i ) (< i  l )) (assert_20_12_142 source  l  i ))))
...
(assert (forall ((k Int) (i Int) (l Int) (source (Array Int Int)) ) ( => (assert_20_12_142 source  l  i ) (=> (and (<= 0 k ) (< k  l )) (not (= (select source  k ) 0))))))
(assert (forall ((i Int) (l Int) (source (Array Int Int)) ) ( => (assert_20_12_142 source  l  i ) (assert_21_5_157 source  l  i ))))
;
;(assert)  (!(source[i]==0))
