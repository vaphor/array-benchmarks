...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_119_12_6_abs i1 (select a i1) v N i) (< i N)) (assign_94_15_8_abs i1 (select a i1) v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_194_22_6_abs i1 (select a i1) v N i) (< i N)) (arrayassign_182_25_8_abs i1 (select a i1) v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_269_31_6_abs i1 (select a i1) v N i) (< i N)) (assert_257_34_8_abs i1 (select a i1) v N i))))
