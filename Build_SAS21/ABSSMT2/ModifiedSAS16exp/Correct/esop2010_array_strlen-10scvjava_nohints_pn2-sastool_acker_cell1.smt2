...
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_95_13_1_abs i vacker_0 l i) (while_95_13_1_abs i1 vacker_0 l i) (not (= 0 vacker_0))) (assign_92_15_5_abs i1 vacker_0 l i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_95_13_1_abs i vacker_0 l i) (while_95_13_1_abs i1 vacker_0 l i) (not (not (= 0 vacker_0)))) (assign_101_17_1_abs i1 vacker_0 l i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<l))
(assert (forall ( (acker Int) (l Int) (i Int) (i1 Int)) (=> (and (while_169_19_1_abs i1 acker l i) (< i l)) (assert_157_21_5_abs i1 acker l i))))
