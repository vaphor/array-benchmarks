...
(declare-fun assert_189_29_10 (Int Int Int Int Int Int) Bool)
...
(declare-fun assert_103_18_12 (Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (and (while_145_17_1 a_ind a_val elem pos N i) (< i N)) (assert_103_18_12 a_ind a_val elem pos N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (assert_103_18_12 a_ind a_val elem pos N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_103_18_12 k tmp_select_a elem pos N i)) (and (< a_ind k) (assert_103_18_12 k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k i)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (assert_103_18_12 a_ind a_val elem pos N i) (if_134_19_5 a_ind a_val elem pos N i))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (and (while_216_27_8 a_ind a_val elem pos N i) (< i pos)) (assert_189_29_10 a_ind a_val elem pos N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (assert_189_29_10 a_ind a_val elem pos N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_189_29_10 k tmp_select_a elem pos N i)) (and (< a_ind k) (assert_189_29_10 k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k pos)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (assert_189_29_10 a_ind a_val elem pos N i) (assert_204_30_10 a_ind a_val elem pos N i))))
;
;(assert)  (!(a[i]==elem))
