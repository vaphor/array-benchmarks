...
(assert (forall ((pos Int) (N Int) (i Int) (vabs_0_f_f Int) (a_select Int)) (=> (and (while_14_1_148_abs0 vabs_0_f_f a_select pos N i) (< i N)) (assert_15_13_105_abs0 vabs_0_f_f a_select pos N i))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (a_select Int)) (=> (and (assert_15_13_105_abs0 k a_select pos N i) (>= k 0) (< k i)) (= a_select 0))))
(assert (forall ((i Int) (N Int) (pos Int) (vabs_0_f_f Int) (a_select Int)) (=> (assert_15_13_105_abs0 vabs_0_f_f a_select pos N i) (if_16_5_137_abs0 vabs_0_f_f a_select pos N i))))
...
(assert (forall ((pos Int) (N Int) (i Int) (vabs_0_f_f Int) (a_select Int)) (=> (and (while_23_1_217_abs0 vabs_0_f_f a_select pos N i) (< i pos)) (assert_25_10_191_abs0 vabs_0_f_f a_select pos N i))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (a_select Int)) (=> (and (assert_25_10_191_abs0 k a_select pos N i) (>= k 0) (< k pos)) (= a_select 0))))
(assert (forall ((i Int) (N Int) (pos Int) (vabs_0_f_f Int) (a_select Int)) (=> (assert_25_10_191_abs0 vabs_0_f_f a_select pos N i) (assert_26_10_205_abs0 vabs_0_f_f a_select pos N i))))
