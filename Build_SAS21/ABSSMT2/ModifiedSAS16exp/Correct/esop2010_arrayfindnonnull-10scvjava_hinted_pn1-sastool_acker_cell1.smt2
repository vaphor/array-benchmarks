...
(declare-rel assert_191_25_10_abs (Int Int Int Int Int))
...
(declare-rel assert_105_15_13_abs (Int Int Int Int Int))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_148_14_1_abs i1 acker pos N i) (< i N)) (assert_105_15_13_abs i1 acker pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (acker Int)) (=> (and (assert_105_15_13_abs k acker pos N i) (>= k 0) (< k i)) (= 0 acker))))
(assert (forall ( (i Int) (N Int) (pos Int) (acker Int) (i1 Int)) (=> (assert_105_15_13_abs i1 acker pos N i) (if_137_16_5_abs i1 acker pos N i))))
;
;(if)      if((!(a[i]==0)))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_137_16_5_abs i vacker_0 pos N i) (if_137_16_5_abs i1 vacker_0 pos N i) (not (= 0 vacker_0))) (assign_124_17_2_abs i1 vacker_0 pos N i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_137_16_5_abs i vacker_0 pos N i) (if_137_16_5_abs i1 vacker_0 pos N i) (not (not (= 0 vacker_0)))) (assign_145_20_5_abs i1 vacker_0 pos N i))))
;
;(assign)  pos := i
...
;
;(while)   while((i<pos))
(assert (forall ( (acker Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_217_23_1_abs i1 acker pos N i) (< i pos)) (assert_191_25_10_abs i1 acker pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (acker Int)) (=> (and (assert_191_25_10_abs k acker pos N i) (>= k 0) (< k pos)) (= 0 acker))))
(assert (forall ( (i Int) (N Int) (pos Int) (acker Int) (i1 Int)) (=> (assert_191_25_10_abs i1 acker pos N i) (assert_205_26_10_abs i1 acker pos N i))))
;
;(assert)  (a[i]==0)
