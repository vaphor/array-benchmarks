...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_12_1_122_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_13_12_96_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_13_12_96_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_13_12_96_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_14_5_110_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_19_1_204_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_20_12_172_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_20_12_172_abs (- (- N k) 1) (select a_copy (- (- N k) 1)) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy (- (- N k) 1))))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_20_12_172_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_21_5_192_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_26_1_290_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_27_12_254_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_27_12_254_abs (- (- N k) 1) (select a_copy (- (- N k) 1)) k (select a k) N i) (<= 0 k) (< k N)) (= (select a k) (select a_copy (- (- N k) 1))))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_27_12_254_abs i2 (select a_copy i2) i1 (select a i1) N i) (assert_28_5_278_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
