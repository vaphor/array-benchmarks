...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_17_1_145_abs i1 acker elem pos N i) (< i N)) (assert_18_12_103_abs i1 acker elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (acker Int)) (=> (and (assert_18_12_103_abs k acker elem pos N i) (>= k 0) (< k i)) (not (= acker elem)))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (acker Int) (i1 Int)) (=> (assert_18_12_103_abs i1 acker elem pos N i) (if_19_5_134_abs i1 acker elem pos N i))))
;
;(if)      if((a[i]==elem))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_19_5_134_abs i vacker_0 vacker_0 pos N i) (if_19_5_134_abs i1 vacker_0 vacker_0 pos N i)) (assign_20_2_121_abs i1 vacker_0 vacker_0 pos N i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_19_5_134_abs i vacker_0 elem pos N i) (if_19_5_134_abs i1 vacker_0 elem pos N i) (not (= elem vacker_0))) (assign_23_5_142_abs i1 vacker_0 elem pos N i))))
;
;(assign)  pos := i
...
;
;(while)   while((i<pos))
(assert (forall ( (acker Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_27_8_216_abs i1 acker elem pos N i) (< i pos)) (assert_29_10_189_abs i1 acker elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (acker Int)) (=> (and (assert_29_10_189_abs k acker elem pos N i) (>= k 0) (< k pos)) (not (= acker elem)))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (acker Int) (i1 Int)) (=> (assert_29_10_189_abs i1 acker elem pos N i) (assert_30_10_204_abs i1 acker elem pos N i))))
;
;(assert)  (!(a[i]==elem))
