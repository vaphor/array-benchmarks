...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (c Int) (N Int) (i Int) (i1 Int)) (=> (and (while_121_13_1_abs i1 acker c N i) (< i N)) (assert_99_14_12_abs i1 acker c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (acker Int)) (=> (and (assert_99_14_12_abs k acker c N i) (<= 0 k) (< k i)) (= acker c))))
(assert (forall ( (i Int) (N Int) (c Int) (acker Int) (i1 Int)) (=> (assert_99_14_12_abs i1 acker c N i) (arrayassign_109_15_5_abs i1 acker c N i))))
;
;(aassign) a[i] := c
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (c Int) (N Int) (i Int) (i1 Int)) (=> (and (while_187_20_1_abs i1 acker c N i) (< i N)) (assert_161_21_12_abs i1 acker c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (acker Int)) (=> (and (assert_161_21_12_abs k acker c N i) (<= 0 k) (< k N)) (= acker c))))
(assert (forall ( (i Int) (N Int) (c Int) (acker Int) (i1 Int)) (=> (assert_161_21_12_abs i1 acker c N i) (assert_175_22_5_abs i1 acker c N i))))
;
;(assert)  (a[i]==c)
