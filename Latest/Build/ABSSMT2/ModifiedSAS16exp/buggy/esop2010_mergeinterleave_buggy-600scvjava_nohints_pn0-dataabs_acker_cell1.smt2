...
;
;(aassign) res[i] := a[i]
(assert (forall ( (i Int) (size Int) (modul Int) (vacker_1 Int) (vacker_0 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_16_5_78_abs i3 acker i2 acker1 i vacker_0 modul size i) (arrayassign_16_5_78_abs i3 acker i2 acker1 i1 vacker_1 modul size i)) (assign_17_5_87_abs i3 (ite (= i i3) vacker_0 acker) i2 acker1 i1 vacker_1 modul size i))))
;
;(assign)  i := (i+2)
...
;
;(aassign) res[i] := b[i]
(assert (forall ( (i Int) (size Int) (modul Int) (acker2 Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int)) (=> (and (=> (= i i2) (= vacker_0 vacker_1)) (arrayassign_22_5_118_abs i3 acker i vacker_0 i1 acker2 modul size i) (arrayassign_22_5_118_abs i3 acker i2 vacker_1 i1 acker2 modul size i)) (assign_23_5_127_abs i3 (ite (= i i3) vacker_0 acker) i2 vacker_1 i1 acker2 modul size i))))
;
;(assign)  i := (i+2)
