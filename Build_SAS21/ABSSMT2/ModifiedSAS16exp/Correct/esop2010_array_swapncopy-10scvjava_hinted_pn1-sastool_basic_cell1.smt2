...
;
;(while)   while((i<N))
(assert (forall ( (b_copy (Array Int Int)) (a_copy (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (while_245_20_1_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (< i N)) (assert_175_21_12_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int))) (=> (and (assert_175_21_12_abs 17 (select b_copy 17) k (select a_copy k) k (select b k) 17 (select a 17) N i) (<= 0 k) (< k i)) (= (select a_copy k) (select b k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (assert_175_21_12_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (assert_205_22_12_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
;
;(assert)  (((0<=k)&&(k<i))=>(b_copy[k]==a[k]))
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int))) (=> (and (assert_205_22_12_abs k (select b_copy k) 17 (select a_copy 17) 17 (select b 17) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select b_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (assert_205_22_12_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (arrayassign_219_23_5_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (b_copy (Array Int Int)) (a_copy (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (while_367_29_8_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (< i N)) (assert_289_30_10_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int))) (=> (and (assert_289_30_10_abs 17 (select b_copy 17) k (select a_copy k) k (select b k) 17 (select a 17) N i) (<= 0 k) (< k N)) (= (select a_copy k) (select b k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (assert_289_30_10_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (assert_319_31_10_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
;
;(assert)  (((0<=k)&&(k<N))=>(b_copy[k]==a[k]))
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int))) (=> (and (assert_319_31_10_abs k (select b_copy k) 17 (select a_copy 17) 17 (select b 17) k (select a k) N i) (<= 0 k) (< k N)) (= (select a k) (select b_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (a_copy (Array Int Int)) (b_copy (Array Int Int)) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (assert_319_31_10_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (assert_337_32_3_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
;
;(assert)  (a[i]==b_copy[i])
