...
(declare-fun assert_25_11_256 (Int Int Int Int Int Int Int) Bool)
(declare-fun while_24_1_289 (Int Int Int Int Int Int Int) Bool)
(declare-fun assign_23_8_206 (Int Int Int Int Int Int Int) Bool)
(declare-fun assert_21_8_200 (Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_17_12_132 (Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_16_1_161 b_ind b_val a_ind a_val Nb Na i) (< i (+ Na Nb))) (assert_17_12_132 b_ind b_val a_ind a_val Nb Na i))))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_16_1_161 b_ind b_val a_ind a_val Nb Na i) (not (< i (+ Na Nb)))) (assert_21_8_200 b_ind b_val a_ind a_val Nb Na i))))
;
;(assert)  (((Na<=k)&&(k<i))=>(a[k]==b[(k-Na)]))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_b Int)) (=> (and (assert_17_12_132 b_ind b_val a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_17_12_132 b_ind b_val k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_17_12_132 b_ind b_val k tmp_select_a Nb Na i))) (or (and (= b_ind (- k Na)) (= tmp_select_b b_val)) (and (< (- k Na) b_ind) (assert_17_12_132 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_17_12_132 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_17_12_132 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))) (and (< b_ind (- k Na)) (assert_17_12_132 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_17_12_132 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_17_12_132 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))))) (=> (and (<= Na k) (< k i)) (= tmp_select_a tmp_select_b)))))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (assert_17_12_132 b_ind b_val a_ind a_val Nb Na i) (arrayassign_18_5_149 b_ind b_val a_ind a_val Nb Na i))))
;
;(aassign) a[i] := b[(i-Na)]
...
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_b Int)) (=> (and (assert_21_8_200 b_ind b_val a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_21_8_200 b_ind b_val k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_21_8_200 b_ind b_val k tmp_select_a Nb Na i))) (or (and (= b_ind (- k Na)) (= tmp_select_b b_val)) (and (< (- k Na) b_ind) (assert_21_8_200 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_21_8_200 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_21_8_200 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))) (and (< b_ind (- k Na)) (assert_21_8_200 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_21_8_200 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_21_8_200 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))))) (=> (and (<= Na k) (< k (+ Na Nb))) (= tmp_select_a tmp_select_b)))))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (assert_21_8_200 b_ind b_val a_ind a_val Nb Na i) (assign_23_8_206 b_ind b_val a_ind a_val Nb Na i))))
;
;(assign)  i := Na
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_24_1_289 b_ind b_val a_ind a_val Nb Na i) (< i (+ Na Nb))) (assert_25_11_256 b_ind b_val a_ind a_val Nb Na i))))
...
;
;(assert)  (((Na<=k)&&(k<(Na+Nb)))=>(a[k]==b[(k-Na)]))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_b Int)) (=> (and (assert_25_11_256 b_ind b_val a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_25_11_256 b_ind b_val k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_25_11_256 b_ind b_val k tmp_select_a Nb Na i))) (or (and (= b_ind (- k Na)) (= tmp_select_b b_val)) (and (< (- k Na) b_ind) (assert_25_11_256 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_25_11_256 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_25_11_256 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))) (and (< b_ind (- k Na)) (assert_25_11_256 (- k Na) tmp_select_b a_ind a_val Nb Na i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_25_11_256 (- k Na) tmp_select_b k tmp_select_a Nb Na i)) (and (< a_ind k) (assert_25_11_256 (- k Na) tmp_select_b k tmp_select_a Nb Na i)))))) (=> (and (<= Na k) (< k (+ Na Nb))) (= tmp_select_a tmp_select_b)))))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (assert_25_11_256 b_ind b_val a_ind a_val Nb Na i) (assert_26_11_277 b_ind b_val a_ind a_val Nb Na i))))
;
;(assert)  (a[i]==b[(i-Na)])
