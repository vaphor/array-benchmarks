...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_14_1_148_abs i1 vacker_0 i1 vacker_0 pos N i) (while_14_1_148_abs i1 vacker_0 i2 vacker_1 pos N i) (while_14_1_148_abs i2 vacker_1 i1 vacker_0 pos N i) (while_14_1_148_abs i2 vacker_1 i2 vacker_1 pos N i) (< i N)) (assert_15_13_105_abs i2 vacker_1 i1 vacker_0 pos N i))))
...
(assert (forall ( (i Int) (N Int) (pos Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_15_13_105_abs i1 vacker_0 i1 vacker_0 pos N i) (assert_15_13_105_abs i1 vacker_0 i2 vacker_1 pos N i) (assert_15_13_105_abs i2 vacker_1 i1 vacker_0 pos N i) (assert_15_13_105_abs i2 vacker_1 i2 vacker_1 pos N i)) (if_16_5_137_abs i2 vacker_1 i1 vacker_0 pos N i))))
;
;(if)      if((!(a[i]==0)))
...
;
;(while)   while((i<pos))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_23_1_217_abs i1 vacker_0 i1 vacker_0 pos N i) (while_23_1_217_abs i1 vacker_0 i2 vacker_1 pos N i) (while_23_1_217_abs i2 vacker_1 i1 vacker_0 pos N i) (while_23_1_217_abs i2 vacker_1 i2 vacker_1 pos N i) (< i pos)) (assert_25_10_191_abs i2 vacker_1 i1 vacker_0 pos N i))))
...
(assert (forall ( (i Int) (N Int) (pos Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_25_10_191_abs i1 vacker_0 i1 vacker_0 pos N i) (assert_25_10_191_abs i1 vacker_0 i2 vacker_1 pos N i) (assert_25_10_191_abs i2 vacker_1 i1 vacker_0 pos N i) (assert_25_10_191_abs i2 vacker_1 i2 vacker_1 pos N i)) (assert_26_10_205_abs i2 vacker_1 i1 vacker_0 pos N i))))
;
;(assert)  (a[i]==0)
