...
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_115_12_1_abs i2 acker1 i vacker_0 l i) (while_115_12_1_abs i2 acker1 i1 vacker_0 l i) (not (= 0 vacker_0))) (arrayassign_103_14_5_abs i2 acker1 i1 vacker_0 l i))))
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_115_12_1_abs i2 acker1 i vacker_0 l i) (while_115_12_1_abs i2 acker1 i1 vacker_0 l i) (not (not (= 0 vacker_0)))) (assign_151_18_1_abs i2 acker1 i1 vacker_0 l i))))
;
;(aassign) dest[i] := source[i]
(assert (forall ( (i Int) (l Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_103_14_5_abs i2 acker i vacker_0 l i) (arrayassign_103_14_5_abs i2 acker i1 vacker_0 l i)) (assign_112_15_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_0 l i))))
;
;(assign)  i := (i+1)
