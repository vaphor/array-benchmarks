...
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_12_1_115_abs i2 acker1 i vacker_0 l i) (while_12_1_115_abs i2 acker1 i1 vacker_0 l i) (not (= 0 vacker_0))) (assert_13_12_89_abs i2 acker1 i1 vacker_0 l i))))
(assert (forall ( (acker1 Int) (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_12_1_115_abs i2 acker1 i vacker_0 l i) (while_12_1_115_abs i2 acker1 i1 vacker_0 l i) (not (not (= 0 vacker_0)))) (assert_17_8_145_abs i2 acker1 i1 vacker_0 l i))))
;
