...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_12_1_122 a_copy  a  N  i ) (< i  N )) (arrayassign_14_5_110 a_copy  a  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_19_1_204 a_copy  a  N  i ) (< i  N )) (arrayassign_21_5_192 a_copy  a  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_26_1_290 a_copy  a  N  i ) (< i  N )) (assert_28_5_278 a_copy  a  N  i ))))
