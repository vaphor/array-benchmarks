...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_136_13_1_abs i1 (select a i1) i1 (select a i1) c N i) (while_136_13_1_abs i1 (select a i1) i2 (select a i2) c N i) (while_136_13_1_abs i2 (select a i2) i1 (select a i1) c N i) (while_136_13_1_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (assert_108_14_12_abs i2 (select a i2) i1 (select a i1) c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_108_14_12_abs k (select a k) k (select a k) c N i) (<= 0 k) (< k i)) (= (+ (* 2 k) c) (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_108_14_12_abs i1 (select a i1) i1 (select a i1) c N i) (assert_108_14_12_abs i1 (select a i1) i2 (select a i2) c N i) (assert_108_14_12_abs i2 (select a i2) i1 (select a i1) c N i) (assert_108_14_12_abs i2 (select a i2) i2 (select a i2) c N i)) (arrayassign_124_15_5_abs i2 (select a i2) i1 (select a i1) c N i))))
;
;(aassign) a[i] := ((2*i)+c)
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_217_20_1_abs i1 (select a i1) i1 (select a i1) c N i) (while_217_20_1_abs i1 (select a i1) i2 (select a i2) c N i) (while_217_20_1_abs i2 (select a i2) i1 (select a i1) c N i) (while_217_20_1_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (assert_185_21_12_abs i2 (select a i2) i1 (select a i1) c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_185_21_12_abs k (select a k) k (select a k) c N i) (<= 0 k) (< k N)) (= (+ (* 2 k) c) (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_185_21_12_abs i1 (select a i1) i1 (select a i1) c N i) (assert_185_21_12_abs i1 (select a i1) i2 (select a i2) c N i) (assert_185_21_12_abs i2 (select a i2) i1 (select a i1) c N i) (assert_185_21_12_abs i2 (select a i2) i2 (select a i2) c N i)) (assert_205_22_5_abs i2 (select a i2) i1 (select a i1) c N i))))
;
;(assert)  (a[i]==((2*i)+c))
