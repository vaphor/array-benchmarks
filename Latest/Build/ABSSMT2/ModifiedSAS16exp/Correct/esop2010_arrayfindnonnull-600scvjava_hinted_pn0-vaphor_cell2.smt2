...
(declare-fun assert_25_10_191 (Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_15_13_105 (Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_14_1_148 a0_ind a0_val a1_ind a1_val pos N i) (< i N)) (assert_15_13_105 a0_ind a0_val a1_ind a1_val pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_15_13_105 a0_ind a0_val a1_ind a1_val pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_15_13_105 k tmp_select_a a1_ind a1_val pos N i) (< k a0_ind) (assert_15_13_105 k tmp_select_a a0_ind a0_val pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_15_13_105 k tmp_select_a a1_ind a1_val pos N i) (< a0_ind k) (assert_15_13_105 a0_ind a0_val k tmp_select_a pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_15_13_105 a1_ind a1_val k tmp_select_a pos N i) (< a0_ind k) (assert_15_13_105 a0_ind a0_val k tmp_select_a pos N i)))) (=> (and (>= k 0) (< k i)) (= tmp_select_a 0)))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_15_13_105 a0_ind a0_val a1_ind a1_val pos N i)) (if_16_5_137 a0_ind a0_val a1_ind a1_val pos N i))))
;
;(if)      if((!(a[i]==0)))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_23_1_217 a0_ind a0_val a1_ind a1_val pos N i) (< i pos)) (assert_25_10_191 a0_ind a0_val a1_ind a1_val pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_25_10_191 a0_ind a0_val a1_ind a1_val pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_25_10_191 k tmp_select_a a1_ind a1_val pos N i) (< k a0_ind) (assert_25_10_191 k tmp_select_a a0_ind a0_val pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_25_10_191 k tmp_select_a a1_ind a1_val pos N i) (< a0_ind k) (assert_25_10_191 a0_ind a0_val k tmp_select_a pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_25_10_191 a1_ind a1_val k tmp_select_a pos N i) (< a0_ind k) (assert_25_10_191 a0_ind a0_val k tmp_select_a pos N i)))) (=> (and (>= k 0) (< k pos)) (= tmp_select_a 0)))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_25_10_191 a0_ind a0_val a1_ind a1_val pos N i)) (assert_26_10_205 a0_ind a0_val a1_ind a1_val pos N i))))
;
;(assert)  (a[i]==0)
