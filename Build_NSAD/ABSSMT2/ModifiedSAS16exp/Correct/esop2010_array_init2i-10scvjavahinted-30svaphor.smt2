...
(declare-fun assert_21_12_185 (Int Int Int Int Int) Bool)
...
(declare-fun assert_14_12_108 (Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_13_1_136 a_ind a_val c N i) (< i N)) (assert_14_12_108 a_ind a_val c N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (assert_14_12_108 a_ind a_val c N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_14_12_108 k tmp_select_a c N i)) (and (< a_ind k) (assert_14_12_108 k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k i)) (= tmp_select_a (+ (* 2 k) c))))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (assert_14_12_108 a_ind a_val c N i) (arrayassign_15_5_124 a_ind a_val c N i))))
;
;(aassign) a[i] := ((2*i)+c)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_20_1_217 a_ind a_val c N i) (< i N)) (assert_21_12_185 a_ind a_val c N i))))
...
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int) (k Int) (tmp_select_a Int)) (=> (and (assert_21_12_185 a_ind a_val c N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_21_12_185 k tmp_select_a c N i)) (and (< a_ind k) (assert_21_12_185 k tmp_select_a c N i)))) (=> (and (<= 0 k) (< k N)) (= tmp_select_a (+ (* 2 k) c))))))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (assert_21_12_185 a_ind a_val c N i) (assert_22_5_205 a_ind a_val c N i))))
;
;(assert)  (a[i]==((2*i)+c))
