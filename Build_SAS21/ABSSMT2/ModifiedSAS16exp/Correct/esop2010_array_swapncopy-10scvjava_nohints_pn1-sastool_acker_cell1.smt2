...
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker2 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_105_15_5_abs i4 acker i3 acker1 i2 acker2 i vacker_0 N i) (arrayassign_105_15_5_abs i4 acker i3 acker1 i2 acker2 i1 vacker_0 N i)) (arrayassign_119_16_12_abs i4 acker i3 (ite (= i i3) vacker_0 acker1) i2 acker2 i1 vacker_0 N i))))
;
;(aassign) b_copy[i] := b[i]
(assert (forall ( (i Int) (N Int) (acker3 Int) (vacker_1 Int) (vacker_0 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i2) (= vacker_0 vacker_1)) (arrayassign_119_16_12_abs i4 acker i3 acker1 i vacker_0 i1 acker3 N i) (arrayassign_119_16_12_abs i4 acker i3 acker1 i2 vacker_0 i1 acker3 N i)) (assign_128_17_5_abs i4 (ite (= i i4) vacker_0 acker) i3 acker1 i2 vacker_0 i1 acker3 N i))))
;
;(assign)  i := (i+1)
...
(assert (forall ( (i Int) (N Int) (acker3 Int) (vacker_1 Int) (vacker_0 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i2) (= vacker_0 vacker_1)) (arrayassign_219_23_5_abs i4 acker i3 acker1 i vacker_0 i1 acker3 N i) (arrayassign_219_23_5_abs i4 acker i3 acker1 i2 vacker_0 i1 acker3 N i)) (arrayassign_233_24_5_abs i4 acker i3 (ite (= i i3) vacker_0 acker1) i2 vacker_0 i1 acker3 N i))))
;
;(aassign) b_copy[i] := a[i]
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker2 Int) (acker1 Int) (acker Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_233_24_5_abs i4 acker i3 acker1 i2 acker2 i vacker_0 N i) (arrayassign_233_24_5_abs i4 acker i3 acker1 i2 acker2 i1 vacker_0 N i)) (assign_242_25_5_abs i4 (ite (= i i4) vacker_0 acker) i3 acker1 i2 acker2 i1 vacker_0 N i))))
;
;(assign)  i := (i+1)
