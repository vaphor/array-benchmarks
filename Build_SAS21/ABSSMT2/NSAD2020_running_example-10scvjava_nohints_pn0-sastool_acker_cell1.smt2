...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_12_6_119_abs i1 acker v N i) (< i N)) (assign_15_8_94_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_22_6_194_abs i1 acker v N i) (< i N)) (arrayassign_25_8_182_abs i1 acker v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_31_6_269_abs i1 acker v N i) (< i N)) (assert_34_8_257_abs i1 acker v N i))))
