...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_125_12_1_abs i2 acker1 i1 acker N i) (< i N)) (arrayassign_113_14_5_abs i2 acker1 i1 acker N i))))
...
(assert (forall ( (i Int) (N Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_113_14_5_abs i2 acker i vacker_0 N i) (arrayassign_113_14_5_abs i2 acker i1 vacker_1 N i)) (assign_122_15_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_1 N i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<N))
(assert (forall ( (acker1 Int) (acker Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_202_19_1_abs i2 acker1 i1 acker N i) (< i N)) (assert_190_21_5_abs i2 acker1 i1 acker N i))))
