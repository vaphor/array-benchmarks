...
(declare-fun assert_29_10_189 (Int Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_18_12_103 (Int Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_17_1_145 a0_ind a0_val a1_ind a1_val elem pos N i) (< i N)) (assert_18_12_103 a0_ind a0_val a1_ind a1_val elem pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_18_12_103 a0_ind a0_val a1_ind a1_val elem pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_18_12_103 k tmp_select_a a1_ind a1_val elem pos N i) (< k a0_ind) (assert_18_12_103 k tmp_select_a a0_ind a0_val elem pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_18_12_103 k tmp_select_a a1_ind a1_val elem pos N i) (< a0_ind k) (assert_18_12_103 a0_ind a0_val k tmp_select_a elem pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_18_12_103 a1_ind a1_val k tmp_select_a elem pos N i) (< a0_ind k) (assert_18_12_103 a0_ind a0_val k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k i)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_18_12_103 a0_ind a0_val a1_ind a1_val elem pos N i)) (if_19_5_134 a0_ind a0_val a1_ind a1_val elem pos N i))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_27_8_216 a0_ind a0_val a1_ind a1_val elem pos N i) (< i pos)) (assert_29_10_189 a0_ind a0_val a1_ind a1_val elem pos N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (k Int) (pos Int) (tmp_select_a Int)) (=> (and (< a0_ind a1_ind) (assert_29_10_189 a0_ind a0_val a1_ind a1_val elem pos N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_29_10_189 k tmp_select_a a1_ind a1_val elem pos N i) (< k a0_ind) (assert_29_10_189 k tmp_select_a a0_ind a0_val elem pos N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_29_10_189 k tmp_select_a a1_ind a1_val elem pos N i) (< a0_ind k) (assert_29_10_189 a0_ind a0_val k tmp_select_a elem pos N i)) (and (< a1_ind k) (< a1_ind k) (assert_29_10_189 a1_ind a1_val k tmp_select_a elem pos N i) (< a0_ind k) (assert_29_10_189 a0_ind a0_val k tmp_select_a elem pos N i)))) (=> (and (>= k 0) (< k pos)) (not (= tmp_select_a elem))))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (elem Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (assert_29_10_189 a0_ind a0_val a1_ind a1_val elem pos N i)) (assert_30_10_204 a0_ind a0_val a1_ind a1_val elem pos N i))))
;
;(assert)  (!(a[i]==elem))
