...
(assert (forall ( (i Int) (j Int) (size Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_14_5_77_abs i2 acker i vacker_0 size j i) (arrayassign_14_5_77_abs i2 acker i1 vacker_0 size j i)) (assign_15_5_86_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_0 size j i))))
;
;(assign)  i := (i+2)
