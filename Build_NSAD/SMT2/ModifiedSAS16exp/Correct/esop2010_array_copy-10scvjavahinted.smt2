...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_13_12_99 a_copy  a  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (select a  k ) (select a_copy  k ))))))
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_19_1_202 a_copy  a  N  i ) (< i  N )) (assert_20_12_172 a_copy  a  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_20_12_172 a_copy  a  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (select a  k ) (select a_copy  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_20_12_172 a_copy  a  N  i ) (assert_21_5_190 a_copy  a  N  i ))))
;
;(assert)  (a[i]==a_copy[i])
