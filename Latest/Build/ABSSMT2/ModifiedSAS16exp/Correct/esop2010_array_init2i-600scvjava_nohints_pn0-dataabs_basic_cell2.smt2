...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_13_1_136_abs i1 (select a i1) i1 (select a i1) c N i) (while_13_1_136_abs i1 (select a i1) i2 (select a i2) c N i) (while_13_1_136_abs i2 (select a i2) i1 (select a i1) c N i) (while_13_1_136_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (arrayassign_15_5_124_abs i2 (select a i2) i1 (select a i1) c N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_20_1_217_abs i1 (select a i1) i1 (select a i1) c N i) (while_20_1_217_abs i1 (select a i1) i2 (select a i2) c N i) (while_20_1_217_abs i2 (select a i2) i1 (select a i1) c N i) (while_20_1_217_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (assert_22_5_205_abs i2 (select a i2) i1 (select a i1) c N i))))
