...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (and (while_17_1_145 a_ind a_val elem pos N i) (< i N)) (if_19_5_134 a_ind a_val elem pos N i))))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (elem Int) (i Int) (pos Int)) (=> (and (while_27_8_216 a_ind a_val elem pos N i) (< i pos)) (assert_30_10_204 a_ind a_val elem pos N i))))
