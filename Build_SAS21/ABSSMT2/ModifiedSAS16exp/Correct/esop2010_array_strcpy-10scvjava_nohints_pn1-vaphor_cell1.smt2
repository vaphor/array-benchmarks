...
(assert (forall ((dest_ind Int) (dest_val Int) (i Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (while_115_12_1 dest_ind dest_val source_ind source_val l i) (not (= tmp_select_source 0)) (or (and (= source_ind i) (= tmp_select_source source_val)) (and (< i source_ind) (while_115_12_1 dest_ind dest_val i tmp_select_source l i)) (and (< source_ind i) (while_115_12_1 dest_ind dest_val i tmp_select_source l i)))) (arrayassign_103_14_5 dest_ind dest_val source_ind source_val l i))))
(assert (forall ((dest_ind Int) (dest_val Int) (i Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (while_115_12_1 dest_ind dest_val source_ind source_val l i) (not (not (= tmp_select_source 0))) (or (and (= source_ind i) (= tmp_select_source source_val)) (and (< i source_ind) (while_115_12_1 dest_ind dest_val i tmp_select_source l i)) (and (< source_ind i) (while_115_12_1 dest_ind dest_val i tmp_select_source l i)))) (assign_151_18_1 dest_ind dest_val source_ind source_val l i))))
;
...
;
;(assign)  l := i
(assert (forall ((dest_ind Int) (dest_val Int) (i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assign_151_18_1 dest_ind dest_val source_ind source_val l i) (assign_187_20_8 dest_ind dest_val source_ind source_val i i))))
;
;(assign)  i := 0
(assert (forall ((dest_ind Int) (dest_val Int) (i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assign_187_20_8 dest_ind dest_val source_ind source_val l i) (while_285_22_8 dest_ind dest_val source_ind source_val l 0))))
;
;(while)   while((i<l))
(assert (forall ((dest_ind Int) (dest_val Int) (i Int) (l Int) (source_ind Int) (source_val Int)) (=> (and (while_285_22_8 dest_ind dest_val source_ind source_val l i) (< i l)) (assert_273_25_3 dest_ind dest_val source_ind source_val l i))))
