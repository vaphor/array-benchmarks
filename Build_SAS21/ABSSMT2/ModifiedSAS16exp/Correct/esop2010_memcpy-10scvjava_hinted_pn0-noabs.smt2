...
(declare-fun assert_23_12_166 ((Array Int Int) (Array Int Int) Int Int ) Bool)
...
(declare-fun assert_16_12_96 ((Array Int Int) (Array Int Int) Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_15_1_122 a_copy  a  N  i ) (< i  N )) (assert_16_12_96 a_copy  a  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_16_12_96 a_copy  a  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (select a_copy  k ) (select a  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_16_12_96 a_copy  a  N  i ) (arrayassign_17_5_110 a_copy  a  N  i ))))
;
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_22_1_196 a_copy  a  N  i ) (< i  N )) (assert_23_12_166 a_copy  a  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_23_12_166 a_copy  a  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (select a_copy  k ) (select a  k ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) ) ( => (assert_23_12_166 a_copy  a  N  i ) (assert_24_5_184 a_copy  a  N  i ))))
;
;(assert)  (a_copy[i]==a[i])
