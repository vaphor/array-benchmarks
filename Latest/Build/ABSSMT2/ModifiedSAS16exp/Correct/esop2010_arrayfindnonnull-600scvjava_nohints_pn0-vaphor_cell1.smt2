...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (pos Int)) (=> (and (while_14_1_148 a_ind a_val pos N i) (< i N)) (if_16_5_137 a_ind a_val pos N i))))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (i Int) (pos Int)) (=> (and (while_23_1_217 a_ind a_val pos N i) (< i pos)) (assert_26_10_205 a_ind a_val pos N i))))
