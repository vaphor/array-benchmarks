...
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_13_1_95_abs i vacker_0 l i) (while_13_1_95_abs i1 vacker_0 l i) (not (= 0 vacker_0))) (assert_14_12_83_abs i1 vacker_0 l i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (while_13_1_95_abs i vacker_0 l i) (while_13_1_95_abs i1 vacker_0 l i) (not (not (= 0 vacker_0)))) (assign_17_1_101_abs i1 vacker_0 l i))))
;
;(assert)  (((0<=k)&&(k<i))=>(!(source[k]==0)))
(assert (forall ( (k Int) (i Int) (l Int) (acker Int)) (=> (and (assert_14_12_83_abs k acker l i) (<= 0 k) (< k i)) (not (= 0 acker)))))
(assert (forall ( (i Int) (l Int) (acker Int) (i1 Int)) (=> (assert_14_12_83_abs i1 acker l i) (assign_15_5_92_abs i1 acker l i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<l))
(assert (forall ( (acker Int) (l Int) (i Int) (i1 Int)) (=> (and (while_19_1_169_abs i1 acker l i) (< i l)) (assert_20_12_142_abs i1 acker l i))))
...
(assert (forall ( (k Int) (i Int) (l Int) (acker Int)) (=> (and (assert_20_12_142_abs k acker l i) (<= 0 k) (< k l)) (not (= 0 acker)))))
(assert (forall ( (i Int) (l Int) (acker Int) (i1 Int)) (=> (assert_20_12_142_abs i1 acker l i) (assert_21_5_157_abs i1 acker l i))))
;
;(assert)  (!(source[i]==0))
