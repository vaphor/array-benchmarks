...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (and (while_19_1_202 a_copy_ind a_copy_val a_ind a_val N i) (< i N)) (assert_20_12_172 a_copy_ind a_copy_val a_ind a_val N i))))
...
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int) (k Int) (tmp_select_a Int) (tmp_select_a_copy Int)) (=> (and (assert_20_12_172 a_copy_ind a_copy_val a_ind a_val N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_20_12_172 a_copy_ind a_copy_val k tmp_select_a N i)) (and (< a_ind k) (assert_20_12_172 a_copy_ind a_copy_val k tmp_select_a N i))) (or (and (= a_copy_ind k) (= tmp_select_a_copy a_copy_val)) (and (< k a_copy_ind) (assert_20_12_172 k tmp_select_a_copy a_ind a_val N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_20_12_172 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_ind k) (assert_20_12_172 k tmp_select_a_copy k tmp_select_a N i)))) (and (< a_copy_ind k) (assert_20_12_172 k tmp_select_a_copy a_ind a_val N i) (or (and (= a_ind k) (= tmp_select_a a_val)) (and (< k a_ind) (assert_20_12_172 k tmp_select_a_copy k tmp_select_a N i)) (and (< a_ind k) (assert_20_12_172 k tmp_select_a_copy k tmp_select_a N i)))))) (=> (and (<= 0 k) (< k N)) (= tmp_select_a tmp_select_a_copy)))))
(assert (forall ((N Int) (a_copy_ind Int) (a_copy_val Int) (a_ind Int) (a_val Int) (i Int)) (=> (assert_20_12_172 a_copy_ind a_copy_val a_ind a_val N i) (assert_21_5_190 a_copy_ind a_copy_val a_ind a_val N i))))
;
;(assert)  (a[i]==a_copy[i])
