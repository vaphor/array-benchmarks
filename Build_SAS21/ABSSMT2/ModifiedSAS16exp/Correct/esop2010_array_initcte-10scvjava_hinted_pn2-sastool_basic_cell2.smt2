...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_121_13_1_abs i1 (select a i1) i1 (select a i1) c N i) (while_121_13_1_abs i1 (select a i1) i2 (select a i2) c N i) (while_121_13_1_abs i2 (select a i2) i1 (select a i1) c N i) (while_121_13_1_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (assert_99_14_12_abs i2 (select a i2) i1 (select a i1) c N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_99_14_12_abs k (select a k) k (select a k) c N i) (<= 0 k) (< k i)) (= c (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_99_14_12_abs i1 (select a i1) i1 (select a i1) c N i) (assert_99_14_12_abs i1 (select a i1) i2 (select a i2) c N i) (assert_99_14_12_abs i2 (select a i2) i1 (select a i1) c N i) (assert_99_14_12_abs i2 (select a i2) i2 (select a i2) c N i)) (arrayassign_109_15_5_abs i2 (select a i2) i1 (select a i1) c N i))))
;
;(aassign) a[i] := c
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_187_20_1_abs i1 (select a i1) i1 (select a i1) c N i) (while_187_20_1_abs i1 (select a i1) i2 (select a i2) c N i) (while_187_20_1_abs i2 (select a i2) i1 (select a i1) c N i) (while_187_20_1_abs i2 (select a i2) i2 (select a i2) c N i) (< i N)) (assert_161_21_12_abs i2 (select a i2) i1 (select a i1) c N i))))
(assert (forall ( (a (Array Int Int)) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_187_20_1_abs i1 (select a i1) i1 (select a i1) c N i) (while_187_20_1_abs i1 (select a i1) i2 (select a i2) c N i) (while_187_20_1_abs i2 (select a i2) i1 (select a i1) c N i) (while_187_20_1_abs i2 (select a i2) i2 (select a i2) c N i) (not (< i N))) (end_abs i2 (select a i2) i1 (select a i1) c N i))))
;
;(assert)  (((0<=k)&&(k<N))=>(a[k]==c))
(assert (forall ( (k Int) (i Int) (N Int) (c Int) (a (Array Int Int))) (=> (and (assert_161_21_12_abs k (select a k) k (select a k) c N i) (<= 0 k) (< k N)) (= c (select a k)))))
(assert (forall ( (i Int) (N Int) (c Int) (a (Array Int Int)) (i1 Int) (i2 Int)) (=> (and (assert_161_21_12_abs i1 (select a i1) i1 (select a i1) c N i) (assert_161_21_12_abs i1 (select a i1) i2 (select a i2) c N i) (assert_161_21_12_abs i2 (select a i2) i1 (select a i1) c N i) (assert_161_21_12_abs i2 (select a i2) i2 (select a i2) c N i)) (assert_175_22_5_abs i2 (select a i2) i1 (select a i1) c N i))))
;
;(assert)  (a[i]==c)
