...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_148_14_1_abs i1 (select a i1) i1 (select a i1) pos N i) (while_148_14_1_abs i1 (select a i1) i2 (select a i2) pos N i) (while_148_14_1_abs i2 (select a i2) i1 (select a i1) pos N i) (while_148_14_1_abs i2 (select a i2) i2 (select a i2) pos N i) (< i N)) (if_137_16_5_abs i2 (select a i2) i1 (select a i1) pos N i))))
...
;
;(while)   while((i<pos))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_217_23_1_abs i1 (select a i1) i1 (select a i1) pos N i) (while_217_23_1_abs i1 (select a i1) i2 (select a i2) pos N i) (while_217_23_1_abs i2 (select a i2) i1 (select a i1) pos N i) (while_217_23_1_abs i2 (select a i2) i2 (select a i2) pos N i) (< i pos)) (assert_205_26_10_abs i2 (select a i2) i1 (select a i1) pos N i))))
