...
;
;(while)   while((i<pos))
(assert (forall ( (a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_216_27_8_abs i1 (select a i1) i1 (select a i1) elem pos N i) (while_216_27_8_abs i1 (select a i1) i2 (select a i2) elem pos N i) (while_216_27_8_abs i2 (select a i2) i1 (select a i1) elem pos N i) (while_216_27_8_abs i2 (select a i2) i2 (select a i2) elem pos N i) (< i pos)) (assert_204_30_10_abs i2 (select a i2) i1 (select a i1) elem pos N i))))
