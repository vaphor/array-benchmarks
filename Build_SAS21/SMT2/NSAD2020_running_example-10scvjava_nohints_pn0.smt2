...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_12_6_119 a  v  N  i ) (< i  N )) (assign_15_8_94 a  v  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_22_6_194 a  v  N  i ) (< i  N )) (arrayassign_25_8_182 a  v  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_31_6_269 a  v  N  i ) (< i  N )) (assert_34_8_257 a  v  N  i ))))
