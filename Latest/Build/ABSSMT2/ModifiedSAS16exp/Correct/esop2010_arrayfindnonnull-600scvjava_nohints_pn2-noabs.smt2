...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (pos Int) (N Int) (i Int) ) ( => ( and (while_148_14_1 a  pos  N  i ) (< i  N )) (if_137_16_5 a  pos  N  i ))))
...
;
;(while)   while((i<pos))
(assert (forall ((a (Array Int Int)) (pos Int) (N Int) (i Int) ) ( => ( and (while_217_23_1 a  pos  N  i ) (< i  pos )) (assert_205_26_10 a  pos  N  i ))))
