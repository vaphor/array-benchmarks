...
;
;(while)   while((i<pos))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_216_27_8_abs i1 vacker_0 i1 vacker_0 elem pos N i) (while_216_27_8_abs i1 vacker_0 i2 vacker_1 elem pos N i) (while_216_27_8_abs i2 vacker_1 i1 vacker_0 elem pos N i) (while_216_27_8_abs i2 vacker_1 i2 vacker_1 elem pos N i) (< i pos)) (assert_204_30_10_abs i2 vacker_1 i1 vacker_0 elem pos N i))))
