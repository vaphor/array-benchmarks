...
;
;(while)   while((i<l))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (l Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_19_1_169_abs i1 vacker_0 i1 vacker_0 l i) (while_19_1_169_abs i1 vacker_0 i2 vacker_1 l i) (while_19_1_169_abs i2 vacker_1 i1 vacker_0 l i) (while_19_1_169_abs i2 vacker_1 i2 vacker_1 l i) (< i l)) (assert_21_5_157_abs i2 vacker_1 i1 vacker_0 l i))))
