...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_125_12_1 a_copy  a  N  i ) (< i  N )) (arrayassign_113_14_5 a_copy  a  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_202_19_1 a_copy  a  N  i ) (< i  N )) (assert_190_21_5 a_copy  a  N  i ))))
