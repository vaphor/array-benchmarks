...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_122_12_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_96_13_12_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_96_13_12_abs k (select a_copy k) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy k)))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_96_13_12_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_110_14_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_204_19_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_172_20_12_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_172_20_12_abs (- (- N k) 1) (select a_copy (- (- N k) 1)) k (select a k) N i) (<= 0 k) (< k i)) (= (select a k) (select a_copy (- (- N k) 1))))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_172_20_12_abs i2 (select a_copy i2) i1 (select a i1) N i) (arrayassign_192_21_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_290_26_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_254_27_12_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int))) (=> (and (assert_254_27_12_abs (- (- N k) 1) (select a_copy (- (- N k) 1)) k (select a k) N i) (<= 0 k) (< k N)) (= (select a k) (select a_copy (- (- N k) 1))))))
(assert (forall ( (i Int) (N Int) (a (Array Int Int)) (a_copy (Array Int Int)) (i1 Int) (i2 Int)) (=> (assert_254_27_12_abs i2 (select a_copy i2) i1 (select a i1) N i) (assert_278_28_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
;
