...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_13_1_136_abs i1 vacker_0 i1 vacker_0 c N i) (while_13_1_136_abs i1 vacker_0 i2 vacker_1 c N i) (while_13_1_136_abs i2 vacker_1 i1 vacker_0 c N i) (while_13_1_136_abs i2 vacker_1 i2 vacker_1 c N i) (< i N)) (arrayassign_15_5_124_abs i2 vacker_1 i1 vacker_0 c N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (c Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_20_1_217_abs i1 vacker_0 i1 vacker_0 c N i) (while_20_1_217_abs i1 vacker_0 i2 vacker_1 c N i) (while_20_1_217_abs i2 vacker_1 i1 vacker_0 c N i) (while_20_1_217_abs i2 vacker_1 i2 vacker_1 c N i) (< i N)) (assert_22_5_205_abs i2 vacker_1 i1 vacker_0 c N i))))
