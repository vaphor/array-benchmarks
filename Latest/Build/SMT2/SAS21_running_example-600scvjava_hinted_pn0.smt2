...
(declare-fun assert_30_8_240 ((Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_22_8_165 ((Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_13_8_82 ((Array Int Int) Int Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_11_6_119 a  v  N  i ) (< i  N )) (assert_13_8_82 a  v  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_13_8_82 a  v  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (mod (select a  k ) 2) 0)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_13_8_82 a  v  N  i ) (assign_14_8_94 a  v  N  i ))))
;
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_20_6_194 a  v  N  i ) (< i  N )) (assert_22_8_165 a  v  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_22_8_165 a  v  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (mod (select a  k ) 2) 1)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_22_8_165 a  v  N  i ) (arrayassign_23_8_182 a  v  N  i ))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_28_6_269 a  v  N  i ) (< i  N )) (assert_30_8_240 a  v  N  i ))))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_28_6_269 a  v  N  i ) (not (< i  N ))) (end a  v  N  i ))))
;
;(assert)  (((0<=k)&&(k<N))=>((a[k]%2)==1))
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_30_8_240 a  v  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (mod (select a  k ) 2) 1)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_30_8_240 a  v  N  i ) (assert_31_8_257 a  v  N  i ))))
;
;(assert)  ((a[i]%2)==1)
