...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_119_11_6_abs i1 vacker_0 i1 vacker_0 v N i) (while_119_11_6_abs i1 vacker_0 i2 vacker_1 v N i) (while_119_11_6_abs i2 vacker_1 i1 vacker_0 v N i) (while_119_11_6_abs i2 vacker_1 i2 vacker_1 v N i) (< i N)) (assign_94_14_8_abs i2 vacker_1 i1 vacker_0 v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_194_20_6_abs i1 vacker_0 i1 vacker_0 v N i) (while_194_20_6_abs i1 vacker_0 i2 vacker_1 v N i) (while_194_20_6_abs i2 vacker_1 i1 vacker_0 v N i) (while_194_20_6_abs i2 vacker_1 i2 vacker_1 v N i) (< i N)) (arrayassign_182_23_8_abs i2 vacker_1 i1 vacker_0 v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_269_28_6_abs i1 vacker_0 i1 vacker_0 v N i) (while_269_28_6_abs i1 vacker_0 i2 vacker_1 v N i) (while_269_28_6_abs i2 vacker_1 i1 vacker_0 v N i) (while_269_28_6_abs i2 vacker_1 i2 vacker_1 v N i) (< i N)) (assert_257_31_8_abs i2 vacker_1 i1 vacker_0 v N i))))
