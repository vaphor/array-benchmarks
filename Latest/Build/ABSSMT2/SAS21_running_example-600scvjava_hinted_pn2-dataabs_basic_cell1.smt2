...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_119_11_6_abs i1 (select a i1) v N i) (< i N)) (assert_82_13_8_abs i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_82_13_8_abs k (select a k) v N i) (<= 0 k) (< k i)) (= 0 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int)) (=> (assert_82_13_8_abs i1 (select a i1) v N i) (assign_94_14_8_abs i1 (select a i1) v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_194_20_6_abs i1 (select a i1) v N i) (< i N)) (assert_165_22_8_abs i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_165_22_8_abs k (select a k) v N i) (<= 0 k) (< k i)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int)) (=> (assert_165_22_8_abs i1 (select a i1) v N i) (arrayassign_182_23_8_abs i1 (select a i1) v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (v Int) (N Int) (i Int) (i1 Int)) (=> (and (while_269_28_6_abs i1 (select a i1) v N i) (< i N)) (assert_240_30_8_abs i1 (select a i1) v N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (v Int) (a (Array Int Int))) (=> (and (assert_240_30_8_abs k (select a k) v N i) (<= 0 k) (< k N)) (= 1 (mod (select a k) 2)))))
(assert (forall ( (i Int) (N Int) (v Int) (a (Array Int Int)) (i1 Int)) (=> (assert_240_30_8_abs i1 (select a i1) v N i) (assert_257_31_8_abs i1 (select a i1) v N i))))
;
;(assert)  ((a[i]%2)==1)
