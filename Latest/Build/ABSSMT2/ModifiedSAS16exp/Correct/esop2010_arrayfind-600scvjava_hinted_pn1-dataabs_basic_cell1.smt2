...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_145_17_1_abs i1 (select a i1) elem pos N i) (< i N)) (assert_103_18_12_abs i1 (select a i1) elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int))) (=> (and (assert_103_18_12_abs k (select a k) elem pos N i) (>= k 0) (< k i)) (not (= elem (select a k))))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) (i1 Int)) (=> (assert_103_18_12_abs i1 (select a i1) elem pos N i) (if_134_19_5_abs i1 (select a i1) elem pos N i))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ( (a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_216_27_8_abs i1 (select a i1) elem pos N i) (< i pos)) (assert_189_29_10_abs i1 (select a i1) elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int))) (=> (and (assert_189_29_10_abs k (select a k) elem pos N i) (>= k 0) (< k pos)) (not (= elem (select a k))))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) (i1 Int)) (=> (assert_189_29_10_abs i1 (select a i1) elem pos N i) (assert_204_30_10_abs i1 (select a i1) elem pos N i))))
;
;(assert)  (!(a[i]==elem))
