...
(declare-rel assert_189_29_10_abs (Int Int Int Int Int Int))
...
(declare-rel assert_103_18_12_abs (Int Int Int Int Int Int))
...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_145_17_1_abs i1 acker elem pos N i) (< i N)) (assert_103_18_12_abs i1 acker elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (acker Int)) (=> (and (assert_103_18_12_abs k acker elem pos N i) (>= k 0) (< k i)) (not (= acker elem)))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (acker Int) (i1 Int)) (=> (assert_103_18_12_abs i1 acker elem pos N i) (if_134_19_5_abs i1 acker elem pos N i))))
;
;(if)      if((a[i]==elem))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_134_19_5_abs i vacker_0 vacker_0 pos N i) (if_134_19_5_abs i1 vacker_1 vacker_0 pos N i)) (assign_121_20_2_abs i1 vacker_1 vacker_0 pos N i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_134_19_5_abs i vacker_0 elem pos N i) (if_134_19_5_abs i1 vacker_1 elem pos N i) (not (= elem vacker_0))) (assign_142_23_5_abs i1 vacker_1 elem pos N i))))
;
;(assign)  pos := i
...
;
;(while)   while((i<pos))
(assert (forall ( (acker Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_216_27_8_abs i1 acker elem pos N i) (< i pos)) (assert_189_29_10_abs i1 acker elem pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (elem Int) (acker Int)) (=> (and (assert_189_29_10_abs k acker elem pos N i) (>= k 0) (< k pos)) (not (= acker elem)))))
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (acker Int) (i1 Int)) (=> (assert_189_29_10_abs i1 acker elem pos N i) (assert_204_30_10_abs i1 acker elem pos N i))))
;
;(assert)  (!(a[i]==elem))
