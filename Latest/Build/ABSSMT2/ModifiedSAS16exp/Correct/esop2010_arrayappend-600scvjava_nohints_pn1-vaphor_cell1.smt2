...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_161_16_1 b_ind b_val a_ind a_val Nb Na i) (< i (+ Na Nb))) (arrayassign_149_18_5 b_ind b_val a_ind a_val Nb Na i))))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_161_16_1 b_ind b_val a_ind a_val Nb Na i) (not (< i (+ Na Nb)))) (assign_206_23_8 b_ind b_val a_ind a_val Nb Na i))))
;
;(aassign) a[i] := b[(i-Na)]
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((Na Int) (Nb Int) (a_ind Int) (a_val Int) (b_ind Int) (b_val Int) (i Int)) (=> (and (while_289_24_1 b_ind b_val a_ind a_val Nb Na i) (< i (+ Na Nb))) (assert_277_26_11 b_ind b_val a_ind a_val Nb Na i))))
