...
(declare-fun assert_189_29_10 ((Array Int Int) Int Int Int Int ) Bool)
...
(declare-fun assert_103_18_12 ((Array Int Int) Int Int Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) ) ( => ( and (while_145_17_1 a  elem  pos  N  i ) (< i  N )) (assert_103_18_12 a  elem  pos  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) ) ( => (assert_103_18_12 a  elem  pos  N  i ) (=> (and (>= k  0) (< k  i )) (not (= (select a  k ) elem ))))))
(assert (forall ((i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) ) ( => (assert_103_18_12 a  elem  pos  N  i ) (if_134_19_5 a  elem  pos  N  i ))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) ) ( => ( and (while_216_27_8 a  elem  pos  N  i ) (< i  pos )) (assert_189_29_10 a  elem  pos  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) ) ( => (assert_189_29_10 a  elem  pos  N  i ) (=> (and (>= k  0) (< k  pos )) (not (= (select a  k ) elem ))))))
(assert (forall ((i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) ) ( => (assert_189_29_10 a  elem  pos  N  i ) (assert_204_30_10 a  elem  pos  N  i ))))
;
;(assert)  (!(a[i]==elem))
