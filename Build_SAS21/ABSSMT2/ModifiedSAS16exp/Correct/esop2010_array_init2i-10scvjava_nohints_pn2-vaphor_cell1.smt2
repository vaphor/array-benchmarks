...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_136_13_1 a_ind a_val c N i) (< i N)) (arrayassign_124_15_5 a_ind a_val c N i))))
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a_ind Int) (a_val Int) (c Int) (i Int)) (=> (and (while_217_20_1 a_ind a_val c N i) (< i N)) (assert_205_22_5 a_ind a_val c N i))))
