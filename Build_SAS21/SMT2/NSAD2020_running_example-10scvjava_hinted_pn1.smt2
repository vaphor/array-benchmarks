...
(declare-fun assert_240_33_8 ((Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_165_24_8 ((Array Int Int) Int Int Int ) Bool)
...
(declare-fun assert_82_14_8 ((Array Int Int) Int Int Int ) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_119_12_6 a  v  N  i ) (< i  N )) (assert_82_14_8 a  v  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_82_14_8 a  v  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (mod (select a  k ) 2) 0)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_82_14_8 a  v  N  i ) (assign_94_15_8 a  v  N  i ))))
;
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_194_22_6 a  v  N  i ) (< i  N )) (assert_165_24_8 a  v  N  i ))))
...
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_165_24_8 a  v  N  i ) (=> (and (<= 0 k ) (< k  i )) (= (mod (select a  k ) 2) 1)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_165_24_8 a  v  N  i ) (arrayassign_182_25_8 a  v  N  i ))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_269_31_6 a  v  N  i ) (< i  N )) (assert_240_33_8 a  v  N  i ))))
(assert (forall ((a (Array Int Int)) (v Int) (N Int) (i Int) ) ( => ( and (while_269_31_6 a  v  N  i ) (not (< i  N ))) (end a  v  N  i ))))
;
;(assert)  (((0<=k)&&(k<N))=>((a[k]%2)==1))
(assert (forall ((k Int) (i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_240_33_8 a  v  N  i ) (=> (and (<= 0 k ) (< k  N )) (= (mod (select a  k ) 2) 1)))))
(assert (forall ((i Int) (N Int) (v Int) (a (Array Int Int)) ) ( => (assert_240_33_8 a  v  N  i ) (assert_257_34_8 a  v  N  i ))))
;
;(assert)  ((a[i]%2)==1)
