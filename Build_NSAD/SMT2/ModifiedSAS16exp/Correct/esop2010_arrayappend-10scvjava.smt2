...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_16_1_161 b  a  Nb  Na  i ) (< i  (+ Na  Nb ))) (arrayassign_18_5_149 b  a  Nb  Na  i ))))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_16_1_161 b  a  Nb  Na  i ) (not (< i  (+ Na  Nb )))) (assign_23_8_206 b  a  Nb  Na  i ))))
;
;(aassign) a[i] := b[(i-Na)]
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ((b (Array Int Int)) (a (Array Int Int)) (Nb Int) (Na Int) (i Int) ) ( => ( and (while_24_1_289 b  a  Nb  Na  i ) (< i  (+ Na  Nb ))) (assert_26_11_277 b  a  Nb  Na  i ))))
