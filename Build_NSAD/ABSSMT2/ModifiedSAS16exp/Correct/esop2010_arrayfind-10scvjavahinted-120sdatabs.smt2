...
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) (vabs_0_f_f Int)) (=> (and (while_17_1_145_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i) (< i N)) (assert_18_12_103_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int))) (=> (and (assert_18_12_103_abs0 k (select a k) elem pos N i) (>= k 0) (< k i)) (not (= (select a k) elem)))))
(assert (forall ((i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) (vabs_0_f_f Int)) (=> (assert_18_12_103_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i) (if_19_5_134_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i))))
...
(assert (forall ((a (Array Int Int)) (elem Int) (pos Int) (N Int) (i Int) (vabs_0_f_f Int)) (=> (and (while_27_8_216_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i) (< i pos)) (assert_29_10_189_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i))))
...
(assert (forall ((k Int) (i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int))) (=> (and (assert_29_10_189_abs0 k (select a k) elem pos N i) (>= k 0) (< k pos)) (not (= (select a k) elem)))))
(assert (forall ((i Int) (N Int) (pos Int) (elem Int) (a (Array Int Int)) (vabs_0_f_f Int)) (=> (assert_29_10_189_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i) (assert_30_10_204_abs0 vabs_0_f_f (select a vabs_0_f_f) elem pos N i))))
