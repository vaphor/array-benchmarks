...
(declare-fun assert_142_20_12 (Int Int Int Int) Bool)
...
(declare-fun assert_83_14_12 (Int Int Int Int) Bool)
...
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (while_95_13_1 source_ind source_val l i) (not (= tmp_select_source 0)) (or (and (= source_ind i) (= tmp_select_source source_val)) (and (< i source_ind) (while_95_13_1 i tmp_select_source l i)) (and (< source_ind i) (while_95_13_1 i tmp_select_source l i)))) (assert_83_14_12 source_ind source_val l i))))
...
(assert (forall ((i Int) (k Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (assert_83_14_12 source_ind source_val l i) (or (and (= source_ind k) (= tmp_select_source source_val)) (and (< k source_ind) (assert_83_14_12 k tmp_select_source l i)) (and (< source_ind k) (assert_83_14_12 k tmp_select_source l i)))) (=> (and (<= 0 k) (< k i)) (not (= tmp_select_source 0))))))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assert_83_14_12 source_ind source_val l i) (assign_92_15_5 source_ind source_val l i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<l))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (and (while_169_19_1 source_ind source_val l i) (< i l)) (assert_142_20_12 source_ind source_val l i))))
...
(assert (forall ((i Int) (k Int) (l Int) (source_ind Int) (source_val Int) (tmp_select_source Int)) (=> (and (assert_142_20_12 source_ind source_val l i) (or (and (= source_ind k) (= tmp_select_source source_val)) (and (< k source_ind) (assert_142_20_12 k tmp_select_source l i)) (and (< source_ind k) (assert_142_20_12 k tmp_select_source l i)))) (=> (and (<= 0 k) (< k l)) (not (= tmp_select_source 0))))))
(assert (forall ((i Int) (l Int) (source_ind Int) (source_val Int)) (=> (assert_142_20_12 source_ind source_val l i) (assert_157_21_5 source_ind source_val l i))))
;
;(assert)  (!(source[i]==0))
