...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_125_12_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (arrayassign_113_14_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (a_copy (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_202_19_1_abs i2 (select a_copy i2) i1 (select a i1) N i) (< i N)) (assert_190_21_5_abs i2 (select a_copy i2) i1 (select a i1) N i))))
