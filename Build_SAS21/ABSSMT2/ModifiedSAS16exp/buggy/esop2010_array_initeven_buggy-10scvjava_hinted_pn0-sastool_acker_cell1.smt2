...
;
;(assign)  u := a[i]
(assert (forall ( (i Int) (size Int) (tmp Int) (c Int) (u Int) (vacker_1 Int) (vacker_0 Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (assign_18_5_100_abs i vacker_0 u c tmp size i) (assign_18_5_100_abs i1 vacker_0 u c tmp size i)) (assert_19_5_114_abs i1 vacker_0 vacker_0 c tmp size i))))
;
;(assert)  (a[i]==1)
