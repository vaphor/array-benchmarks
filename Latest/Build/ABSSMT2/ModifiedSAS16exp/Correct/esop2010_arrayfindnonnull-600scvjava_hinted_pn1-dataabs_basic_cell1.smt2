...
;
;(while)   while((i<N))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_148_14_1_abs i1 (select a i1) pos N i) (< i N)) (assert_105_15_13_abs i1 (select a i1) pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (a (Array Int Int))) (=> (and (assert_105_15_13_abs k (select a k) pos N i) (>= k 0) (< k i)) (= 0 (select a k)))))
(assert (forall ( (i Int) (N Int) (pos Int) (a (Array Int Int)) (i1 Int)) (=> (assert_105_15_13_abs i1 (select a i1) pos N i) (if_137_16_5_abs i1 (select a i1) pos N i))))
;
;(if)      if((!(a[i]==0)))
...
;
;(while)   while((i<pos))
(assert (forall ( (a (Array Int Int)) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_217_23_1_abs i1 (select a i1) pos N i) (< i pos)) (assert_191_25_10_abs i1 (select a i1) pos N i))))
...
(assert (forall ( (k Int) (i Int) (N Int) (pos Int) (a (Array Int Int))) (=> (and (assert_191_25_10_abs k (select a k) pos N i) (>= k 0) (< k pos)) (= 0 (select a k)))))
(assert (forall ( (i Int) (N Int) (pos Int) (a (Array Int Int)) (i1 Int)) (=> (assert_191_25_10_abs i1 (select a i1) pos N i) (assert_205_26_10_abs i1 (select a i1) pos N i))))
;
;(assert)  (a[i]==0)
