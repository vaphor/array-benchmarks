...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_136_13_1 a  c  N  i ) (< i  N )) (arrayassign_124_15_5 a  c  N  i ))))
...
;
;(while)   while((i<N))
(assert (forall ((a (Array Int Int)) (c Int) (N Int) (i Int) ) ( => ( and (while_217_20_1 a  c  N  i ) (< i  N )) (assert_205_22_5 a  c  N  i ))))
