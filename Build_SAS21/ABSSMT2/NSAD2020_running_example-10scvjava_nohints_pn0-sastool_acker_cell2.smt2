...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_12_6_119_abs i1 vacker_0 i1 vacker_0 v N i) (while_12_6_119_abs i1 vacker_0 i2 vacker_0 v N i) (while_12_6_119_abs i2 vacker_0 i1 vacker_0 v N i) (while_12_6_119_abs i2 vacker_0 i2 vacker_0 v N i) (< i N)) (assign_15_8_94_abs i2 vacker_0 i1 vacker_0 v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_22_6_194_abs i1 vacker_0 i1 vacker_0 v N i) (while_22_6_194_abs i1 vacker_0 i2 vacker_0 v N i) (while_22_6_194_abs i2 vacker_0 i1 vacker_0 v N i) (while_22_6_194_abs i2 vacker_0 i2 vacker_0 v N i) (< i N)) (arrayassign_25_8_182_abs i2 vacker_0 i1 vacker_0 v N i))))
...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (v Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_31_6_269_abs i1 vacker_0 i1 vacker_0 v N i) (while_31_6_269_abs i1 vacker_0 i2 vacker_0 v N i) (while_31_6_269_abs i2 vacker_0 i1 vacker_0 v N i) (while_31_6_269_abs i2 vacker_0 i2 vacker_0 v N i) (< i N)) (assert_34_8_257_abs i2 vacker_0 i1 vacker_0 v N i))))
