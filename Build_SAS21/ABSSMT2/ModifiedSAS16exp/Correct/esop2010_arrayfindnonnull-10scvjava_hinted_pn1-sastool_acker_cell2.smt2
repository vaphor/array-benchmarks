...
;
;(while)   while((i<N))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_148_14_1_abs i1 vacker_0 i1 vacker_0 pos N i) (while_148_14_1_abs i1 vacker_0 i2 vacker_0 pos N i) (while_148_14_1_abs i2 vacker_0 i1 vacker_0 pos N i) (while_148_14_1_abs i2 vacker_0 i2 vacker_0 pos N i) (< i N)) (assert_105_15_13_abs i2 vacker_0 i1 vacker_0 pos N i))))
...
(assert (forall ( (i Int) (N Int) (pos Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_105_15_13_abs i1 vacker_0 i1 vacker_0 pos N i) (assert_105_15_13_abs i1 vacker_0 i2 vacker_0 pos N i) (assert_105_15_13_abs i2 vacker_0 i1 vacker_0 pos N i) (assert_105_15_13_abs i2 vacker_0 i2 vacker_0 pos N i)) (if_137_16_5_abs i2 vacker_0 i1 vacker_0 pos N i))))
;
;(if)      if((!(a[i]==0)))
...
;
;(while)   while((i<pos))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_217_23_1_abs i1 vacker_0 i1 vacker_0 pos N i) (while_217_23_1_abs i1 vacker_0 i2 vacker_0 pos N i) (while_217_23_1_abs i2 vacker_0 i1 vacker_0 pos N i) (while_217_23_1_abs i2 vacker_0 i2 vacker_0 pos N i) (< i pos)) (assert_191_25_10_abs i2 vacker_0 i1 vacker_0 pos N i))))
...
(assert (forall ( (i Int) (N Int) (pos Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_191_25_10_abs i1 vacker_0 i1 vacker_0 pos N i) (assert_191_25_10_abs i1 vacker_0 i2 vacker_0 pos N i) (assert_191_25_10_abs i2 vacker_0 i1 vacker_0 pos N i) (assert_191_25_10_abs i2 vacker_0 i2 vacker_0 pos N i)) (assert_205_26_10_abs i2 vacker_0 i1 vacker_0 pos N i))))
;
;(assert)  (a[i]==0)
