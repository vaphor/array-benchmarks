...
(declare-fun assert_240_33_8 (Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_165_24_8 (Int Int Int Int Int Int Int) Bool)
...
(declare-fun assert_82_14_8 (Int Int Int Int Int Int Int) Bool)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (while_119_12_6 a0_ind a0_val a1_ind a1_val v N i) (< i N)) (assert_82_14_8 a0_ind a0_val a1_ind a1_val v N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_82_14_8 a0_ind a0_val a1_ind a1_val v N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_82_14_8 k tmp_select_a a1_ind a1_val v N i) (< k a0_ind) (assert_82_14_8 k tmp_select_a a0_ind a0_val v N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_82_14_8 k tmp_select_a a1_ind a1_val v N i) (< a0_ind k) (assert_82_14_8 a0_ind a0_val k tmp_select_a v N i)) (and (< a1_ind k) (< a1_ind k) (assert_82_14_8 a1_ind a1_val k tmp_select_a v N i) (< a0_ind k) (assert_82_14_8 a0_ind a0_val k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 0)))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_82_14_8 a0_ind a0_val a1_ind a1_val v N i)) (assign_94_15_8 a0_ind a0_val a1_ind a1_val v N i))))
;
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (while_194_22_6 a0_ind a0_val a1_ind a1_val v N i) (< i N)) (assert_165_24_8 a0_ind a0_val a1_ind a1_val v N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_165_24_8 a0_ind a0_val a1_ind a1_val v N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_165_24_8 k tmp_select_a a1_ind a1_val v N i) (< k a0_ind) (assert_165_24_8 k tmp_select_a a0_ind a0_val v N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_165_24_8 k tmp_select_a a1_ind a1_val v N i) (< a0_ind k) (assert_165_24_8 a0_ind a0_val k tmp_select_a v N i)) (and (< a1_ind k) (< a1_ind k) (assert_165_24_8 a1_ind a1_val k tmp_select_a v N i) (< a0_ind k) (assert_165_24_8 a0_ind a0_val k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k i)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_165_24_8 a0_ind a0_val a1_ind a1_val v N i)) (arrayassign_182_25_8 a0_ind a0_val a1_ind a1_val v N i))))
;
;(aassign) a[i] := (a[i]+1)
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (while_269_31_6 a0_ind a0_val a1_ind a1_val v N i) (< i N)) (assert_240_33_8 a0_ind a0_val a1_ind a1_val v N i))))
...
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (k Int) (tmp_select_a Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_240_33_8 a0_ind a0_val a1_ind a1_val v N i) (or (and (= a0_ind k) (= tmp_select_a a0_val)) (and (= a1_ind k) (= tmp_select_a a1_val)) (and (< k a0_ind) (< k a1_ind) (assert_240_33_8 k tmp_select_a a1_ind a1_val v N i) (< k a0_ind) (assert_240_33_8 k tmp_select_a a0_ind a0_val v N i)) (and (< a0_ind k) (< k a1_ind) (< k a1_ind) (assert_240_33_8 k tmp_select_a a1_ind a1_val v N i) (< a0_ind k) (assert_240_33_8 a0_ind a0_val k tmp_select_a v N i)) (and (< a1_ind k) (< a1_ind k) (assert_240_33_8 a1_ind a1_val k tmp_select_a v N i) (< a0_ind k) (assert_240_33_8 a0_ind a0_val k tmp_select_a v N i)))) (=> (and (<= 0 k) (< k N)) (= (mod tmp_select_a 2) 1)))))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (v Int)) (=> (and (< a0_ind a1_ind) (assert_240_33_8 a0_ind a0_val a1_ind a1_val v N i)) (assert_257_34_8 a0_ind a0_val a1_ind a1_val v N i))))
;
;(assert)  ((a[i]%2)==1)
