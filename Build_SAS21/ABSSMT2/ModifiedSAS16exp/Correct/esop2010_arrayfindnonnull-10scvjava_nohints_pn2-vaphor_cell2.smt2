...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_148_14_1 a0_ind a0_val a1_ind a1_val pos N i) (< i N)) (if_137_16_5 a0_ind a0_val a1_ind a1_val pos N i))))
...
;
;(while)   while((i<pos))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (i Int) (pos Int)) (=> (and (< a0_ind a1_ind) (while_217_23_1 a0_ind a0_val a1_ind a1_val pos N i) (< i pos)) (assert_205_26_10 a0_ind a0_val a1_ind a1_val pos N i))))
