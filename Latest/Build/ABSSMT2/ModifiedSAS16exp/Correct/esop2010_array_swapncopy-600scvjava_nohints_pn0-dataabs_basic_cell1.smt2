...
;
;(while)   while((i<N))
(assert (forall ( (b_copy (Array Int Int)) (a_copy (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) (i1 Int) (i2 Int) (i3 Int) (i4 Int)) (=> (and (while_29_8_367_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i) (< i N)) (assert_32_3_337_abs i4 (select b_copy i4) i3 (select a_copy i3) i2 (select b i2) i1 (select a i1) N i))))
