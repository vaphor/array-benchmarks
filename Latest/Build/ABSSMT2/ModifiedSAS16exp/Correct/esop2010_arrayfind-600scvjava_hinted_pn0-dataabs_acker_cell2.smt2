...
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_18_12_103_abs i1 vacker_0 i1 vacker_0 elem pos N i) (assert_18_12_103_abs i1 vacker_0 i2 vacker_1 elem pos N i) (assert_18_12_103_abs i2 vacker_1 i1 vacker_0 elem pos N i) (assert_18_12_103_abs i2 vacker_1 i2 vacker_1 elem pos N i)) (if_19_5_134_abs i2 vacker_1 i1 vacker_0 elem pos N i))))
;
;(if)      if((a[i]==elem))
...
;
;(while)   while((i<pos))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (elem Int) (pos Int) (N Int) (i Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (while_27_8_216_abs i1 vacker_0 i1 vacker_0 elem pos N i) (while_27_8_216_abs i1 vacker_0 i2 vacker_1 elem pos N i) (while_27_8_216_abs i2 vacker_1 i1 vacker_0 elem pos N i) (while_27_8_216_abs i2 vacker_1 i2 vacker_1 elem pos N i) (< i pos)) (assert_29_10_189_abs i2 vacker_1 i1 vacker_0 elem pos N i))))
...
(assert (forall ( (i Int) (N Int) (pos Int) (elem Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= i1 i2) (= vacker_0 vacker_1)) (assert_29_10_189_abs i1 vacker_0 i1 vacker_0 elem pos N i) (assert_29_10_189_abs i1 vacker_0 i2 vacker_1 elem pos N i) (assert_29_10_189_abs i2 vacker_1 i1 vacker_0 elem pos N i) (assert_29_10_189_abs i2 vacker_1 i2 vacker_1 elem pos N i)) (assert_30_10_204_abs i2 vacker_1 i1 vacker_0 elem pos N i))))
;
;(assert)  (!(a[i]==elem))
