...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (acker1 Int) (acker Int) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_16_1_161_abs i2 acker1 i1 acker Nb Na i) (< i (+ Na Nb))) (arrayassign_18_5_149_abs i2 acker1 i1 acker Nb Na i))))
(assert (forall ( (acker1 Int) (acker Int) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_16_1_161_abs i2 acker1 i1 acker Nb Na i) (not (< i (+ Na Nb)))) (assign_23_8_206_abs i2 acker1 i1 acker Nb Na i))))
;
;(aassign) a[i] := b[(i-Na)]
(assert (forall ( (i Int) (Na Int) (Nb Int) (acker1 Int) (vacker_1 Int) (vacker_0 Int) (i1 Int) (i2 Int)) (=> (and (=> (= (- i Na) i2) (= vacker_0 vacker_1)) (arrayassign_18_5_149_abs (- i Na) vacker_0 i1 acker1 Nb Na i) (arrayassign_18_5_149_abs i2 vacker_0 i1 acker1 Nb Na i)) (assign_19_5_158_abs i2 vacker_0 i1 (ite (= i i1) vacker_0 acker1) Nb Na i))))
;
;(assign)  i := (i+1)
...
;
;(while)   while((i<(Na+Nb)))
(assert (forall ( (acker1 Int) (acker Int) (Nb Int) (Na Int) (i Int) (i1 Int) (i2 Int)) (=> (and (while_24_1_289_abs i2 acker1 i1 acker Nb Na i) (< i (+ Na Nb))) (assert_26_11_277_abs i2 acker1 i1 acker Nb Na i))))
