...
(assert (forall ( (i Int) (j Int) (size Int) (vacker_1 Int) (vacker_0 Int) (acker Int) (i1 Int) (i2 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (arrayassign_77_14_5_abs i2 acker i vacker_0 size j i) (arrayassign_77_14_5_abs i2 acker i1 vacker_1 size j i)) (assign_86_15_5_abs i2 (ite (= i i2) vacker_0 acker) i1 vacker_1 size j i))))
;
;(assign)  i := (i+2)
