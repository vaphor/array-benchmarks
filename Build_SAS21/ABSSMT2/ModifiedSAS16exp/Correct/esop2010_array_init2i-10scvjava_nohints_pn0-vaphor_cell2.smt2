...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (while_13_1_136 a0_ind a0_val a1_ind a1_val c N i) (< i N)) (arrayassign_15_5_124 a0_ind a0_val a1_ind a1_val c N i))))
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a0_ind Int) (a0_val Int) (a1_ind Int) (a1_val Int) (c Int) (i Int)) (=> (and (< a0_ind a1_ind) (while_20_1_217 a0_ind a0_val a1_ind a1_val c N i) (< i N)) (assert_22_5_205 a0_ind a0_val a1_ind a1_val c N i))))
