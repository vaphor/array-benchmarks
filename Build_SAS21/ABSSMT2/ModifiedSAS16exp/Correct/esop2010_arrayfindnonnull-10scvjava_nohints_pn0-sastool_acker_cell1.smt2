...
;
;(while)   while((i<N))
(assert (forall ( (acker Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_14_1_148_abs i1 acker pos N i) (< i N)) (if_16_5_137_abs i1 acker pos N i))))
...
;
;(if)      if((!(a[i]==0)))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_16_5_137_abs i vacker_0 pos N i) (if_16_5_137_abs i1 vacker_0 pos N i) (not (= 0 vacker_0))) (assign_17_2_124_abs i1 vacker_0 pos N i))))
(assert (forall ( (vacker_1 Int) (vacker_0 Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (=> (= i i1) (= vacker_0 vacker_1)) (if_16_5_137_abs i vacker_0 pos N i) (if_16_5_137_abs i1 vacker_0 pos N i) (not (not (= 0 vacker_0)))) (assign_20_5_145_abs i1 vacker_0 pos N i))))
;
;(assign)  pos := i
...
;
;(while)   while((i<pos))
(assert (forall ( (acker Int) (pos Int) (N Int) (i Int) (i1 Int)) (=> (and (while_23_1_217_abs i1 acker pos N i) (< i pos)) (assert_26_10_205_abs i1 acker pos N i))))
