...
(assert (forall ((l Int) (i Int) (vabs_0_f_f Int) (source_select_0 Int) (source_select Int)) (=> (and (=> (= vabs_0_f_f i) (= source_select source_select_0)) (while_13_1_95_abs0 i source_select l i) (while_13_1_95_abs0 vabs_0_f_f source_select_0 l i) (not (= source_select 0))) (assert_14_12_83_abs0 vabs_0_f_f source_select_0 l i))))
...
(assert (forall ((k Int) (i Int) (l Int) (source_select Int)) (=> (and (assert_14_12_83_abs0 k source_select l i) (<= 0 k) (< k i)) (not (= source_select 0)))))
(assert (forall ((i Int) (l Int) (vabs_0_f_f Int) (source_select Int)) (=> (assert_14_12_83_abs0 vabs_0_f_f source_select l i) (assign_15_5_92_abs0 vabs_0_f_f source_select l i))))
...
(assert (forall ((l Int) (i Int) (vabs_0_f_f Int) (source_select Int)) (=> (and (while_19_1_169_abs0 vabs_0_f_f source_select l i) (< i l)) (assert_20_12_142_abs0 vabs_0_f_f source_select l i))))
...
(assert (forall ((k Int) (i Int) (l Int) (source_select Int)) (=> (and (assert_20_12_142_abs0 k source_select l i) (<= 0 k) (< k l)) (not (= source_select 0)))))
(assert (forall ((i Int) (l Int) (vabs_0_f_f Int) (source_select Int)) (=> (assert_20_12_142_abs0 vabs_0_f_f source_select l i) (assert_21_5_157_abs0 vabs_0_f_f source_select l i))))
